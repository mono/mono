...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            {pattern: './publish/netstandard2.0/http-stream-spec.js',watched:true,served:true,included:true},
        ...
        client: {
            ...
            karmaHTML: {
                source: [
                    ...
                    {src:'./publish/netstandard2.0/http-stream-spec.html', tag:'httpstreamspec'},
