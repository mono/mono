...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            {pattern: './publish/http-stream-spec.js',watched:true,served:true,included:true},
            {pattern: './publish/http-spec-with-prom-lib.js',watched:true,served:true,included:true},
            ...
            {pattern: './publish/dotnet.wasm', included: false, served: true, type: 'wasm'},
            {pattern: './publish/dotnet.worker.js', included: false, served: true, type: 'wasm'},
            {pattern: './publish/dotnet.js.mem', included: false, served: true, type: 'wasm'},
            {pattern: './publish/dotnet.js', included: false, served: true},
        ...
        client: {
            ...
            karmaHTML: {
                source: [
                    ...
                    {src:'./publish/http-stream-spec.html', tag:'httpstreamspec'},
                    {src:'./publish/http-spec-with-prom-lib.html', tag:'httpspecwithpromlib'},
