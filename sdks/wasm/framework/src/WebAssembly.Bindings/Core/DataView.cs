...
namespace WebAssembly.Core {
	...
	public class DataView : CoreObject {
		...
		public int ByteOffset => GetObjectProperty<int> ("byteOffset");
		/// <summary>
		...
		public float GetFloat32 (int byteOffset, bool littleEndian = false) => UnBoxValue<float>(Invoke<object> ("getFloat32", byteOffset, littleEndian));
		...
		public double GetFloat64 (int byteOffset, bool littleEndian = false) => UnBoxValue<double>(Invoke<object> ("getFloat64", byteOffset, littleEndian));
		/// <summary>
		...
		public short GetInt16 (int byteOffset, bool littleEndian = false) => UnBoxValue<short>(Invoke<object> ("getInt16", byteOffset, littleEndian));
		/// <summary>
		...
		public int GetInt32 (int byteOffset, bool littleEndian = false) => UnBoxValue<int>(Invoke<object> ("getInt32", byteOffset, littleEndian));
		/// <summary>
		...
		public sbyte GetInt8 (int byteOffset, bool littleEndian = false) => UnBoxValue<sbyte>(Invoke<object> ("getInt8", byteOffset, littleEndian));
		/// <summary>
		...
		public ushort GetUint16 (int byteOffset, bool littleEndian = false) => UnBoxValue<ushort>(Invoke<object> ("getUint16", byteOffset, littleEndian));
		/// <summary>
		...
		/// <param name="byteOffset">Byte offset.</param>
		/// <param name="littleEndian">Indicates whether the 32-bit float is stored in little- or big-endian format. If <c>false</c>, a big-endian value is read.</param>
		public uint GetUint32 (int byteOffset, bool littleEndian = false) => UnBoxValue<uint>(Invoke<object> ("getUint32", byteOffset, littleEndian));
		/// <summary>
		...
		/// <param name="byteOffset">Byte offset.</param>
		/// <param name="littleEndian">Indicates whether the 32-bit float is stored in little- or big-endian format. If <c>false</c>, a big-endian value is read.</param>
		public byte GetUint8 (int byteOffset, bool littleEndian = false) => UnBoxValue<byte>(Invoke<object> ("getUint8", byteOffset, littleEndian));
		/// <summary>
