...
namespace WebAssembly.Core {
	public class Array : CoreObject {
		...
		public int IndexOf (object searchElement, int fromIndex = 0) => Invoke<int> ("indexOf", searchElement, fromIndex);
		/// <summary>
		/// Finds the index of the last occurrence of<paramref name="searchElement" />
		/// </summary>
		/// <returns>The index of the last occurrence</returns>
		/// <param name="searchElement">Search element.</param>
		public int LastIndexOf (object searchElement) => Invoke<int> ("lastIndexOf", searchElement);
		/// <summary>
		...
		public int LastIndexOf (object searchElement, int endIndex) => Invoke<int> ("lastIndexOf", searchElement, endIndex);
