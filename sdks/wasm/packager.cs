...
class Driver {
	...
	void Run (string[] args) {
		...
		ninja.WriteLine ($"  command = MONO_PATH=$mono_path $cross --debug {profiler_aot_args} --aot=$aot_args,llvmonly,asmonly,no-opt,static,direct-icalls,direct-pinvoke,llvm-outfile=$outfile $src_file");
