...
int Mono_Posix_FromAddrFamily (unsigned short x, unsigned short *r)
{
	*r = 0;
	if (x == Mono_Posix_AddrFamily_AF_ALG)
#ifdef AF_ALG
		{*r = AF_ALG; return 0;}
#else /* def AF_ALG */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ALG */
	if (x == Mono_Posix_AddrFamily_AF_APPLETALK)
#ifdef AF_APPLETALK
		{*r = AF_APPLETALK; return 0;}
#else /* def AF_APPLETALK */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_APPLETALK */
	if (x == Mono_Posix_AddrFamily_AF_ASH)
#ifdef AF_ASH
		{*r = AF_ASH; return 0;}
#else /* def AF_ASH */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ASH */
	if (x == Mono_Posix_AddrFamily_AF_ATMPVC)
#ifdef AF_ATMPVC
		{*r = AF_ATMPVC; return 0;}
#else /* def AF_ATMPVC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ATMPVC */
	if (x == Mono_Posix_AddrFamily_AF_ATMSVC)
#ifdef AF_ATMSVC
		{*r = AF_ATMSVC; return 0;}
#else /* def AF_ATMSVC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ATMSVC */
	if (x == Mono_Posix_AddrFamily_AF_AX25)
#ifdef AF_AX25
		{*r = AF_AX25; return 0;}
#else /* def AF_AX25 */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_AX25 */
	if (x == Mono_Posix_AddrFamily_AF_BLUETOOTH)
#ifdef AF_BLUETOOTH
		{*r = AF_BLUETOOTH; return 0;}
#else /* def AF_BLUETOOTH */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_BLUETOOTH */
	if (x == Mono_Posix_AddrFamily_AF_BRIDGE)
#ifdef AF_BRIDGE
		{*r = AF_BRIDGE; return 0;}
#else /* def AF_BRIDGE */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_BRIDGE */
	if (x == Mono_Posix_AddrFamily_AF_CAIF)
#ifdef AF_CAIF
		{*r = AF_CAIF; return 0;}
#else /* def AF_CAIF */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_CAIF */
	if (x == Mono_Posix_AddrFamily_AF_CAN)
#ifdef AF_CAN
		{*r = AF_CAN; return 0;}
#else /* def AF_CAN */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_CAN */
	if (x == Mono_Posix_AddrFamily_AF_DECnet)
#ifdef AF_DECnet
		{*r = AF_DECnet; return 0;}
#else /* def AF_DECnet */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_DECnet */
	if (x == Mono_Posix_AddrFamily_AF_ECONET)
#ifdef AF_ECONET
		{*r = AF_ECONET; return 0;}
#else /* def AF_ECONET */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ECONET */
	if (x == Mono_Posix_AddrFamily_AF_IEEE802154)
#ifdef AF_IEEE802154
		{*r = AF_IEEE802154; return 0;}
#else /* def AF_IEEE802154 */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_IEEE802154 */
	if (x == Mono_Posix_AddrFamily_AF_INET)
#ifdef AF_INET
		{*r = AF_INET; return 0;}
#else /* def AF_INET */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_INET */
	if (x == Mono_Posix_AddrFamily_AF_INET6)
#ifdef AF_INET6
		{*r = AF_INET6; return 0;}
#else /* def AF_INET6 */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_INET6 */
	if (x == Mono_Posix_AddrFamily_AF_IPX)
#ifdef AF_IPX
		{*r = AF_IPX; return 0;}
#else /* def AF_IPX */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_IPX */
	if (x == Mono_Posix_AddrFamily_AF_IRDA)
#ifdef AF_IRDA
		{*r = AF_IRDA; return 0;}
#else /* def AF_IRDA */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_IRDA */
	if (x == Mono_Posix_AddrFamily_AF_ISDN)
#ifdef AF_ISDN
		{*r = AF_ISDN; return 0;}
#else /* def AF_ISDN */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ISDN */
	if (x == Mono_Posix_AddrFamily_AF_IUCV)
#ifdef AF_IUCV
		{*r = AF_IUCV; return 0;}
#else /* def AF_IUCV */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_IUCV */
	if (x == Mono_Posix_AddrFamily_AF_KEY)
#ifdef AF_KEY
		{*r = AF_KEY; return 0;}
#else /* def AF_KEY */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_KEY */
	if (x == Mono_Posix_AddrFamily_AF_LLC)
#ifdef AF_LLC
		{*r = AF_LLC; return 0;}
#else /* def AF_LLC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_LLC */
	if (x == Mono_Posix_AddrFamily_AF_NETBEUI)
#ifdef AF_NETBEUI
		{*r = AF_NETBEUI; return 0;}
#else /* def AF_NETBEUI */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_NETBEUI */
	if (x == Mono_Posix_AddrFamily_AF_NETLINK)
#ifdef AF_NETLINK
		{*r = AF_NETLINK; return 0;}
#else /* def AF_NETLINK */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_NETLINK */
	if (x == Mono_Posix_AddrFamily_AF_NETROM)
#ifdef AF_NETROM
		{*r = AF_NETROM; return 0;}
#else /* def AF_NETROM */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_NETROM */
	if (x == Mono_Posix_AddrFamily_AF_NFC)
#ifdef AF_NFC
		{*r = AF_NFC; return 0;}
#else /* def AF_NFC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_NFC */
	if (x == Mono_Posix_AddrFamily_AF_PACKET)
#ifdef AF_PACKET
		{*r = AF_PACKET; return 0;}
#else /* def AF_PACKET */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_PACKET */
	if (x == Mono_Posix_AddrFamily_AF_PHONET)
#ifdef AF_PHONET
		{*r = AF_PHONET; return 0;}
#else /* def AF_PHONET */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_PHONET */
	if (x == Mono_Posix_AddrFamily_AF_PPPOX)
#ifdef AF_PPPOX
		{*r = AF_PPPOX; return 0;}
#else /* def AF_PPPOX */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_PPPOX */
	if (x == Mono_Posix_AddrFamily_AF_RDS)
#ifdef AF_RDS
		{*r = AF_RDS; return 0;}
#else /* def AF_RDS */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_RDS */
	if (x == Mono_Posix_AddrFamily_AF_ROSE)
#ifdef AF_ROSE
		{*r = AF_ROSE; return 0;}
#else /* def AF_ROSE */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_ROSE */
	if (x == Mono_Posix_AddrFamily_AF_RXRPC)
#ifdef AF_RXRPC
		{*r = AF_RXRPC; return 0;}
#else /* def AF_RXRPC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_RXRPC */
	if (x == Mono_Posix_AddrFamily_AF_SECURITY)
#ifdef AF_SECURITY
		{*r = AF_SECURITY; return 0;}
#else /* def AF_SECURITY */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_SECURITY */
	if (x == Mono_Posix_AddrFamily_AF_SNA)
#ifdef AF_SNA
		{*r = AF_SNA; return 0;}
#else /* def AF_SNA */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_SNA */
	if (x == Mono_Posix_AddrFamily_AF_TIPC)
#ifdef AF_TIPC
		{*r = AF_TIPC; return 0;}
#else /* def AF_TIPC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_TIPC */
	if (x == Mono_Posix_AddrFamily_AF_UNIX)
#ifdef AF_UNIX
		{*r = AF_UNIX; return 0;}
#else /* def AF_UNIX */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_UNIX */
	if (x == Mono_Posix_AddrFamily_AF_UNSPEC)
#ifdef AF_UNSPEC
		{*r = AF_UNSPEC; return 0;}
#else /* def AF_UNSPEC */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_UNSPEC */
	if (x == Mono_Posix_AddrFamily_AF_VSOCK)
#ifdef AF_VSOCK
		{*r = AF_VSOCK; return 0;}
#else /* def AF_VSOCK */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_VSOCK */
	if (x == Mono_Posix_AddrFamily_AF_WANPIPE)
#ifdef AF_WANPIPE
		{*r = AF_WANPIPE; return 0;}
#else /* def AF_WANPIPE */
		{errno = EINVAL; return -1;}
#endif /* ndef AF_WANPIPE */
	if (x == Mono_Posix_AddrFamily_AF_X25)
#ifdef AF_X25
		{*r = AF_X25; return 0;}
#else /* def AF_X25 */
		{errno = EINVAL; return -1;}
...
int Mono_Posix_ToAddrFamily (unsigned short x, unsigned short *r)
{
	*r = 0;
	if (x == 0)
		return 0;
#ifdef AF_ALG
	if (x == AF_ALG)
		{*r = Mono_Posix_AddrFamily_AF_ALG; return 0;}
#endif /* ndef AF_ALG */
#ifdef AF_APPLETALK
	if (x == AF_APPLETALK)
		{*r = Mono_Posix_AddrFamily_AF_APPLETALK; return 0;}
#endif /* ndef AF_APPLETALK */
#ifdef AF_ASH
	if (x == AF_ASH)
		{*r = Mono_Posix_AddrFamily_AF_ASH; return 0;}
#endif /* ndef AF_ASH */
#ifdef AF_ATMPVC
	if (x == AF_ATMPVC)
		{*r = Mono_Posix_AddrFamily_AF_ATMPVC; return 0;}
#endif /* ndef AF_ATMPVC */
#ifdef AF_ATMSVC
	if (x == AF_ATMSVC)
		{*r = Mono_Posix_AddrFamily_AF_ATMSVC; return 0;}
#endif /* ndef AF_ATMSVC */
#ifdef AF_AX25
	if (x == AF_AX25)
		{*r = Mono_Posix_AddrFamily_AF_AX25; return 0;}
#endif /* ndef AF_AX25 */
#ifdef AF_BLUETOOTH
	if (x == AF_BLUETOOTH)
		{*r = Mono_Posix_AddrFamily_AF_BLUETOOTH; return 0;}
#endif /* ndef AF_BLUETOOTH */
#ifdef AF_BRIDGE
	if (x == AF_BRIDGE)
		{*r = Mono_Posix_AddrFamily_AF_BRIDGE; return 0;}
#endif /* ndef AF_BRIDGE */
#ifdef AF_CAIF
	if (x == AF_CAIF)
		{*r = Mono_Posix_AddrFamily_AF_CAIF; return 0;}
#endif /* ndef AF_CAIF */
#ifdef AF_CAN
	if (x == AF_CAN)
		{*r = Mono_Posix_AddrFamily_AF_CAN; return 0;}
#endif /* ndef AF_CAN */
#ifdef AF_DECnet
	if (x == AF_DECnet)
		{*r = Mono_Posix_AddrFamily_AF_DECnet; return 0;}
#endif /* ndef AF_DECnet */
#ifdef AF_ECONET
	if (x == AF_ECONET)
		{*r = Mono_Posix_AddrFamily_AF_ECONET; return 0;}
#endif /* ndef AF_ECONET */
#ifdef AF_IEEE802154
	if (x == AF_IEEE802154)
		{*r = Mono_Posix_AddrFamily_AF_IEEE802154; return 0;}
#endif /* ndef AF_IEEE802154 */
#ifdef AF_INET
	if (x == AF_INET)
		{*r = Mono_Posix_AddrFamily_AF_INET; return 0;}
#endif /* ndef AF_INET */
#ifdef AF_INET6
	if (x == AF_INET6)
		{*r = Mono_Posix_AddrFamily_AF_INET6; return 0;}
#endif /* ndef AF_INET6 */
#ifdef AF_IPX
	if (x == AF_IPX)
		{*r = Mono_Posix_AddrFamily_AF_IPX; return 0;}
#endif /* ndef AF_IPX */
#ifdef AF_IRDA
	if (x == AF_IRDA)
		{*r = Mono_Posix_AddrFamily_AF_IRDA; return 0;}
#endif /* ndef AF_IRDA */
#ifdef AF_ISDN
	if (x == AF_ISDN)
		{*r = Mono_Posix_AddrFamily_AF_ISDN; return 0;}
#endif /* ndef AF_ISDN */
#ifdef AF_IUCV
	if (x == AF_IUCV)
		{*r = Mono_Posix_AddrFamily_AF_IUCV; return 0;}
#endif /* ndef AF_IUCV */
#ifdef AF_KEY
	if (x == AF_KEY)
		{*r = Mono_Posix_AddrFamily_AF_KEY; return 0;}
#endif /* ndef AF_KEY */
#ifdef AF_LLC
	if (x == AF_LLC)
		{*r = Mono_Posix_AddrFamily_AF_LLC; return 0;}
#endif /* ndef AF_LLC */
#ifdef AF_NETBEUI
	if (x == AF_NETBEUI)
		{*r = Mono_Posix_AddrFamily_AF_NETBEUI; return 0;}
#endif /* ndef AF_NETBEUI */
#ifdef AF_NETLINK
	if (x == AF_NETLINK)
		{*r = Mono_Posix_AddrFamily_AF_NETLINK; return 0;}
#endif /* ndef AF_NETLINK */
#ifdef AF_NETROM
	if (x == AF_NETROM)
		{*r = Mono_Posix_AddrFamily_AF_NETROM; return 0;}
#endif /* ndef AF_NETROM */
#ifdef AF_NFC
	if (x == AF_NFC)
		{*r = Mono_Posix_AddrFamily_AF_NFC; return 0;}
#endif /* ndef AF_NFC */
#ifdef AF_PACKET
	if (x == AF_PACKET)
		{*r = Mono_Posix_AddrFamily_AF_PACKET; return 0;}
#endif /* ndef AF_PACKET */
#ifdef AF_PHONET
	if (x == AF_PHONET)
		{*r = Mono_Posix_AddrFamily_AF_PHONET; return 0;}
#endif /* ndef AF_PHONET */
#ifdef AF_PPPOX
	if (x == AF_PPPOX)
		{*r = Mono_Posix_AddrFamily_AF_PPPOX; return 0;}
#endif /* ndef AF_PPPOX */
#ifdef AF_RDS
	if (x == AF_RDS)
		{*r = Mono_Posix_AddrFamily_AF_RDS; return 0;}
#endif /* ndef AF_RDS */
#ifdef AF_ROSE
	if (x == AF_ROSE)
		{*r = Mono_Posix_AddrFamily_AF_ROSE; return 0;}
#endif /* ndef AF_ROSE */
#ifdef AF_RXRPC
	if (x == AF_RXRPC)
		{*r = Mono_Posix_AddrFamily_AF_RXRPC; return 0;}
#endif /* ndef AF_RXRPC */
#ifdef AF_SECURITY
	if (x == AF_SECURITY)
		{*r = Mono_Posix_AddrFamily_AF_SECURITY; return 0;}
#endif /* ndef AF_SECURITY */
#ifdef AF_SNA
	if (x == AF_SNA)
		{*r = Mono_Posix_AddrFamily_AF_SNA; return 0;}
#endif /* ndef AF_SNA */
#ifdef AF_TIPC
	if (x == AF_TIPC)
		{*r = Mono_Posix_AddrFamily_AF_TIPC; return 0;}
#endif /* ndef AF_TIPC */
#ifdef AF_UNIX
	if (x == AF_UNIX)
		{*r = Mono_Posix_AddrFamily_AF_UNIX; return 0;}
#endif /* ndef AF_UNIX */
#ifdef AF_UNSPEC
	if (x == AF_UNSPEC)
		{*r = Mono_Posix_AddrFamily_AF_UNSPEC; return 0;}
#endif /* ndef AF_UNSPEC */
#ifdef AF_VSOCK
	if (x == AF_VSOCK)
		{*r = Mono_Posix_AddrFamily_AF_VSOCK; return 0;}
#endif /* ndef AF_VSOCK */
#ifdef AF_WANPIPE
	if (x == AF_WANPIPE)
		{*r = Mono_Posix_AddrFamily_AF_WANPIPE; return 0;}
#endif /* ndef AF_WANPIPE */
#ifdef AF_X25
	if (x == AF_X25)
		{*r = Mono_Posix_AddrFamily_AF_X25; return 0;}
#endif /* ndef AF_X25 */
	errno = EINVAL; return -1;
}
...
Mono_Posix_FromCmsghdr (struct Mono_Posix_Cmsghdr *from, struct cmsghdr *to)
{
	...
	if (Mono_Posix_FromSockProtocol (from->cmsg_level, &to->cmsg_level) != 0) {
		return -1;
	}
	if (Mono_Posix_FromSockCtrlMsg (from->cmsg_type, &to->cmsg_type) != 0) {
		return -1;
	}
...
Mono_Posix_ToCmsghdr (struct cmsghdr *from, struct Mono_Posix_Cmsghdr *to)
{
	...
	to->cmsg_len   = from->cmsg_len;
	if (Mono_Posix_ToSockProtocol (from->cmsg_level, &to->cmsg_level) != 0) {
		return -1;
	}
	if (Mono_Posix_ToSockCtrlMsg (from->cmsg_type, &to->cmsg_type) != 0) {
		return -1;
	}
...
int Mono_Posix_FromSockCtrlMsg (int x, int *r)
{
	*r = 0;
	if (x == Mono_Posix_SockCtrlMsg_SCM_CREDENTIALS)
#ifdef SCM_CREDENTIALS
		{*r = SCM_CREDENTIALS; return 0;}
#else /* def SCM_CREDENTIALS */
		{errno = EINVAL; return -1;}
#endif /* ndef SCM_CREDENTIALS */
	if (x == Mono_Posix_SockCtrlMsg_SCM_RIGHTS)
#ifdef SCM_RIGHTS
...
int Mono_Posix_ToSockCtrlMsg (int x, int *r)
{
	*r = 0;
	if (x == 0)
		return 0;
	...
	if (x == SCM_CREDENTIALS)
		{*r = Mono_Posix_SockCtrlMsg_SCM_CREDENTIALS; return 0;}
#endif /* ndef SCM_CREDENTIALS */
#ifdef SCM_RIGHTS
	if (x == SCM_RIGHTS)
		{*r = Mono_Posix_SockCtrlMsg_SCM_RIGHTS; return 0;}
#endif /* ndef SCM_RIGHTS */
	errno = EINVAL; return -1;
}

int Mono_Posix_FromSockFlags (int x, int *r)
{
	*r = 0;
	if ((x & Mono_Posix_SockFlags_SOCK_CLOEXEC) == Mono_Posix_SockFlags_SOCK_CLOEXEC)
#ifdef SOCK_CLOEXEC
		*r |= SOCK_CLOEXEC;
#else /* def SOCK_CLOEXEC */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_CLOEXEC */
	if ((x & Mono_Posix_SockFlags_SOCK_NONBLOCK) == Mono_Posix_SockFlags_SOCK_NONBLOCK)
#ifdef SOCK_NONBLOCK
		*r |= SOCK_NONBLOCK;
...
int Mono_Posix_ToSockFlags (int x, int *r)
{
	*r = 0;
	if (x == 0)
		return 0;
...
int Mono_Posix_FromSockOptName (int x, int *r)
{
	*r = 0;
	...
	if (x == Mono_Posix_SockOptName_SO_SECURITY_ENCRYPTION_TRANSPORT)
...
int Mono_Posix_ToSockOptName (int x, int *r)
{
	*r = 0;
	if (x == 0)
		return 0;
#ifdef SO_ACCEPTCONN
	if (x == SO_ACCEPTCONN)
		{*r = Mono_Posix_SockOptName_SO_ACCEPTCONN; return 0;}
#endif /* ndef SO_ACCEPTCONN */
#ifdef SO_ATTACH_FILTER
	if (x == SO_ATTACH_FILTER)
		{*r = Mono_Posix_SockOptName_SO_ATTACH_FILTER; return 0;}
#endif /* ndef SO_ATTACH_FILTER */
#ifdef SO_BINDTODEVICE
	if (x == SO_BINDTODEVICE)
		{*r = Mono_Posix_SockOptName_SO_BINDTODEVICE; return 0;}
#endif /* ndef SO_BINDTODEVICE */
#ifdef SO_BROADCAST
	if (x == SO_BROADCAST)
		{*r = Mono_Posix_SockOptName_SO_BROADCAST; return 0;}
#endif /* ndef SO_BROADCAST */
#ifdef SO_BSDCOMPAT
	if (x == SO_BSDCOMPAT)
		{*r = Mono_Posix_SockOptName_SO_BSDCOMPAT; return 0;}
#endif /* ndef SO_BSDCOMPAT */
#ifdef SO_BUSY_POLL
	if (x == SO_BUSY_POLL)
		{*r = Mono_Posix_SockOptName_SO_BUSY_POLL; return 0;}
#endif /* ndef SO_BUSY_POLL */
#ifdef SO_DEBUG
	if (x == SO_DEBUG)
		{*r = Mono_Posix_SockOptName_SO_DEBUG; return 0;}
#endif /* ndef SO_DEBUG */
#ifdef SO_DETACH_FILTER
	if (x == SO_DETACH_FILTER)
		{*r = Mono_Posix_SockOptName_SO_DETACH_FILTER; return 0;}
#endif /* ndef SO_DETACH_FILTER */
#ifdef SO_DOMAIN
	if (x == SO_DOMAIN)
		{*r = Mono_Posix_SockOptName_SO_DOMAIN; return 0;}
#endif /* ndef SO_DOMAIN */
#ifdef SO_DONTROUTE
	if (x == SO_DONTROUTE)
		{*r = Mono_Posix_SockOptName_SO_DONTROUTE; return 0;}
#endif /* ndef SO_DONTROUTE */
#ifdef SO_ERROR
	if (x == SO_ERROR)
		{*r = Mono_Posix_SockOptName_SO_ERROR; return 0;}
#endif /* ndef SO_ERROR */
#ifdef SO_KEEPALIVE
	if (x == SO_KEEPALIVE)
		{*r = Mono_Posix_SockOptName_SO_KEEPALIVE; return 0;}
#endif /* ndef SO_KEEPALIVE */
#ifdef SO_LINGER
	if (x == SO_LINGER)
		{*r = Mono_Posix_SockOptName_SO_LINGER; return 0;}
#endif /* ndef SO_LINGER */
#ifdef SO_LOCK_FILTER
	if (x == SO_LOCK_FILTER)
		{*r = Mono_Posix_SockOptName_SO_LOCK_FILTER; return 0;}
#endif /* ndef SO_LOCK_FILTER */
#ifdef SO_MARK
	if (x == SO_MARK)
		{*r = Mono_Posix_SockOptName_SO_MARK; return 0;}
#endif /* ndef SO_MARK */
#ifdef SO_MAX_PACING_RATE
	if (x == SO_MAX_PACING_RATE)
		{*r = Mono_Posix_SockOptName_SO_MAX_PACING_RATE; return 0;}
#endif /* ndef SO_MAX_PACING_RATE */
#ifdef SO_NOFCS
	if (x == SO_NOFCS)
		{*r = Mono_Posix_SockOptName_SO_NOFCS; return 0;}
#endif /* ndef SO_NOFCS */
#ifdef SO_NO_CHECK
	if (x == SO_NO_CHECK)
		{*r = Mono_Posix_SockOptName_SO_NO_CHECK; return 0;}
#endif /* ndef SO_NO_CHECK */
#ifdef SO_OOBINLINE
	if (x == SO_OOBINLINE)
		{*r = Mono_Posix_SockOptName_SO_OOBINLINE; return 0;}
#endif /* ndef SO_OOBINLINE */
#ifdef SO_PASSCRED
	if (x == SO_PASSCRED)
		{*r = Mono_Posix_SockOptName_SO_PASSCRED; return 0;}
#endif /* ndef SO_PASSCRED */
#ifdef SO_PASSSEC
	if (x == SO_PASSSEC)
		{*r = Mono_Posix_SockOptName_SO_PASSSEC; return 0;}
#endif /* ndef SO_PASSSEC */
#ifdef SO_PEEK_OFF
	if (x == SO_PEEK_OFF)
		{*r = Mono_Posix_SockOptName_SO_PEEK_OFF; return 0;}
#endif /* ndef SO_PEEK_OFF */
#ifdef SO_PEERCRED
	if (x == SO_PEERCRED)
		{*r = Mono_Posix_SockOptName_SO_PEERCRED; return 0;}
#endif /* ndef SO_PEERCRED */
#ifdef SO_PEERNAME
	if (x == SO_PEERNAME)
		{*r = Mono_Posix_SockOptName_SO_PEERNAME; return 0;}
#endif /* ndef SO_PEERNAME */
#ifdef SO_PEERSEC
	if (x == SO_PEERSEC)
		{*r = Mono_Posix_SockOptName_SO_PEERSEC; return 0;}
#endif /* ndef SO_PEERSEC */
#ifdef SO_PRIORITY
	if (x == SO_PRIORITY)
		{*r = Mono_Posix_SockOptName_SO_PRIORITY; return 0;}
#endif /* ndef SO_PRIORITY */
#ifdef SO_PROTOCOL
	if (x == SO_PROTOCOL)
		{*r = Mono_Posix_SockOptName_SO_PROTOCOL; return 0;}
#endif /* ndef SO_PROTOCOL */
#ifdef SO_RCVBUF
	if (x == SO_RCVBUF)
		{*r = Mono_Posix_SockOptName_SO_RCVBUF; return 0;}
#endif /* ndef SO_RCVBUF */
#ifdef SO_RCVBUFFORCE
	if (x == SO_RCVBUFFORCE)
		{*r = Mono_Posix_SockOptName_SO_RCVBUFFORCE; return 0;}
#endif /* ndef SO_RCVBUFFORCE */
#ifdef SO_RCVLOWAT
	if (x == SO_RCVLOWAT)
		{*r = Mono_Posix_SockOptName_SO_RCVLOWAT; return 0;}
#endif /* ndef SO_RCVLOWAT */
#ifdef SO_RCVTIMEO
	if (x == SO_RCVTIMEO)
		{*r = Mono_Posix_SockOptName_SO_RCVTIMEO; return 0;}
#endif /* ndef SO_RCVTIMEO */
#ifdef SO_REUSEADDR
	if (x == SO_REUSEADDR)
		{*r = Mono_Posix_SockOptName_SO_REUSEADDR; return 0;}
#endif /* ndef SO_REUSEADDR */
#ifdef SO_REUSEPORT
	if (x == SO_REUSEPORT)
		{*r = Mono_Posix_SockOptName_SO_REUSEPORT; return 0;}
#endif /* ndef SO_REUSEPORT */
#ifdef SO_RXQ_OVFL
	if (x == SO_RXQ_OVFL)
		{*r = Mono_Posix_SockOptName_SO_RXQ_OVFL; return 0;}
#endif /* ndef SO_RXQ_OVFL */
#ifdef SO_SECURITY_AUTHENTICATION
	if (x == SO_SECURITY_AUTHENTICATION)
		{*r = Mono_Posix_SockOptName_SO_SECURITY_AUTHENTICATION; return 0;}
#endif /* ndef SO_SECURITY_AUTHENTICATION */
#ifdef SO_SECURITY_ENCRYPTION_NETWORK
	if (x == SO_SECURITY_ENCRYPTION_NETWORK)
		{*r = Mono_Posix_SockOptName_SO_SECURITY_ENCRYPTION_NETWORK; return 0;}
#endif /* ndef SO_SECURITY_ENCRYPTION_NETWORK */
#ifdef SO_SECURITY_ENCRYPTION_TRANSPORT
	if (x == SO_SECURITY_ENCRYPTION_TRANSPORT)
		{*r = Mono_Posix_SockOptName_SO_SECURITY_ENCRYPTION_TRANSPORT; return 0;}
#endif /* ndef SO_SECURITY_ENCRYPTION_TRANSPORT */
#ifdef SO_SELECT_ERR_QUEUE
	if (x == SO_SELECT_ERR_QUEUE)
		{*r = Mono_Posix_SockOptName_SO_SELECT_ERR_QUEUE; return 0;}
#endif /* ndef SO_SELECT_ERR_QUEUE */
#ifdef SO_SNDBUF
	if (x == SO_SNDBUF)
		{*r = Mono_Posix_SockOptName_SO_SNDBUF; return 0;}
#endif /* ndef SO_SNDBUF */
#ifdef SO_SNDBUFFORCE
	if (x == SO_SNDBUFFORCE)
		{*r = Mono_Posix_SockOptName_SO_SNDBUFFORCE; return 0;}
#endif /* ndef SO_SNDBUFFORCE */
#ifdef SO_SNDLOWAT
	if (x == SO_SNDLOWAT)
		{*r = Mono_Posix_SockOptName_SO_SNDLOWAT; return 0;}
#endif /* ndef SO_SNDLOWAT */
#ifdef SO_SNDTIMEO
	if (x == SO_SNDTIMEO)
		{*r = Mono_Posix_SockOptName_SO_SNDTIMEO; return 0;}
#endif /* ndef SO_SNDTIMEO */
#ifdef SO_TIMESTAMP
	if (x == SO_TIMESTAMP)
		{*r = Mono_Posix_SockOptName_SO_TIMESTAMP; return 0;}
#endif /* ndef SO_TIMESTAMP */
#ifdef SO_TIMESTAMPING
	if (x == SO_TIMESTAMPING)
		{*r = Mono_Posix_SockOptName_SO_TIMESTAMPING; return 0;}
#endif /* ndef SO_TIMESTAMPING */
#ifdef SO_TIMESTAMPNS
	if (x == SO_TIMESTAMPNS)
		{*r = Mono_Posix_SockOptName_SO_TIMESTAMPNS; return 0;}
#endif /* ndef SO_TIMESTAMPNS */
#ifdef SO_TYPE
	if (x == SO_TYPE)
		{*r = Mono_Posix_SockOptName_SO_TYPE; return 0;}
#endif /* ndef SO_TYPE */
#ifdef SO_WIFI_STATUS
	if (x == SO_WIFI_STATUS)
		{*r = Mono_Posix_SockOptName_SO_WIFI_STATUS; return 0;}
#endif /* ndef SO_WIFI_STATUS */
	errno = EINVAL; return -1;
}

int Mono_Posix_FromSockProtocol (int x, int *r)
{
	*r = 0;
	if (x == Mono_Posix_SockProtocol_IPPROTO_AH)
#ifdef IPPROTO_AH
		{*r = IPPROTO_AH; return 0;}
#else /* def IPPROTO_AH */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_AH */
	if (x == Mono_Posix_SockProtocol_IPPROTO_BEETPH)
#ifdef IPPROTO_BEETPH
		{*r = IPPROTO_BEETPH; return 0;}
#else /* def IPPROTO_BEETPH */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_BEETPH */
	if (x == Mono_Posix_SockProtocol_IPPROTO_COMP)
#ifdef IPPROTO_COMP
		{*r = IPPROTO_COMP; return 0;}
#else /* def IPPROTO_COMP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_COMP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_DCCP)
#ifdef IPPROTO_DCCP
		{*r = IPPROTO_DCCP; return 0;}
#else /* def IPPROTO_DCCP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_DCCP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_EGP)
#ifdef IPPROTO_EGP
		{*r = IPPROTO_EGP; return 0;}
#else /* def IPPROTO_EGP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_EGP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_ENCAP)
#ifdef IPPROTO_ENCAP
		{*r = IPPROTO_ENCAP; return 0;}
#else /* def IPPROTO_ENCAP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_ENCAP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_ESP)
#ifdef IPPROTO_ESP
		{*r = IPPROTO_ESP; return 0;}
#else /* def IPPROTO_ESP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_ESP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_GRE)
#ifdef IPPROTO_GRE
		{*r = IPPROTO_GRE; return 0;}
#else /* def IPPROTO_GRE */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_GRE */
	if (x == Mono_Posix_SockProtocol_IPPROTO_ICMP)
#ifdef IPPROTO_ICMP
		{*r = IPPROTO_ICMP; return 0;}
#else /* def IPPROTO_ICMP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_ICMP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_IDP)
#ifdef IPPROTO_IDP
		{*r = IPPROTO_IDP; return 0;}
#else /* def IPPROTO_IDP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_IDP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_IGMP)
#ifdef IPPROTO_IGMP
		{*r = IPPROTO_IGMP; return 0;}
#else /* def IPPROTO_IGMP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_IGMP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_IP)
#ifdef IPPROTO_IP
		{*r = IPPROTO_IP; return 0;}
#else /* def IPPROTO_IP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_IP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_IPIP)
#ifdef IPPROTO_IPIP
		{*r = IPPROTO_IPIP; return 0;}
#else /* def IPPROTO_IPIP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_IPIP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_IPV6)
#ifdef IPPROTO_IPV6
		{*r = IPPROTO_IPV6; return 0;}
#else /* def IPPROTO_IPV6 */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_IPV6 */
	if (x == Mono_Posix_SockProtocol_IPPROTO_MTP)
#ifdef IPPROTO_MTP
		{*r = IPPROTO_MTP; return 0;}
#else /* def IPPROTO_MTP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_MTP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_PIM)
#ifdef IPPROTO_PIM
		{*r = IPPROTO_PIM; return 0;}
#else /* def IPPROTO_PIM */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_PIM */
	if (x == Mono_Posix_SockProtocol_IPPROTO_PUP)
#ifdef IPPROTO_PUP
		{*r = IPPROTO_PUP; return 0;}
#else /* def IPPROTO_PUP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_PUP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_RAW)
#ifdef IPPROTO_RAW
		{*r = IPPROTO_RAW; return 0;}
#else /* def IPPROTO_RAW */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_RAW */
	if (x == Mono_Posix_SockProtocol_IPPROTO_RSVP)
#ifdef IPPROTO_RSVP
		{*r = IPPROTO_RSVP; return 0;}
#else /* def IPPROTO_RSVP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_RSVP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_SCTP)
#ifdef IPPROTO_SCTP
		{*r = IPPROTO_SCTP; return 0;}
#else /* def IPPROTO_SCTP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_SCTP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_TCP)
#ifdef IPPROTO_TCP
		{*r = IPPROTO_TCP; return 0;}
#else /* def IPPROTO_TCP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_TCP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_TP)
#ifdef IPPROTO_TP
		{*r = IPPROTO_TP; return 0;}
#else /* def IPPROTO_TP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_TP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_UDP)
#ifdef IPPROTO_UDP
		{*r = IPPROTO_UDP; return 0;}
#else /* def IPPROTO_UDP */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_UDP */
	if (x == Mono_Posix_SockProtocol_IPPROTO_UDPLITE)
#ifdef IPPROTO_UDPLITE
		{*r = IPPROTO_UDPLITE; return 0;}
#else /* def IPPROTO_UDPLITE */
		{errno = EINVAL; return -1;}
#endif /* ndef IPPROTO_UDPLITE */
	if (x == Mono_Posix_SockProtocol_SOL_SOCKET)
#ifdef SOL_SOCKET
...
int Mono_Posix_ToSockProtocol (int x, int *r)
{
	*r = 0;
	if (x == 0)
		return 0;
#ifdef IPPROTO_AH
	if (x == IPPROTO_AH)
		{*r = Mono_Posix_SockProtocol_IPPROTO_AH; return 0;}
#endif /* ndef IPPROTO_AH */
#ifdef IPPROTO_BEETPH
	if (x == IPPROTO_BEETPH)
		{*r = Mono_Posix_SockProtocol_IPPROTO_BEETPH; return 0;}
#endif /* ndef IPPROTO_BEETPH */
#ifdef IPPROTO_COMP
	if (x == IPPROTO_COMP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_COMP; return 0;}
#endif /* ndef IPPROTO_COMP */
#ifdef IPPROTO_DCCP
	if (x == IPPROTO_DCCP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_DCCP; return 0;}
#endif /* ndef IPPROTO_DCCP */
#ifdef IPPROTO_EGP
	if (x == IPPROTO_EGP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_EGP; return 0;}
#endif /* ndef IPPROTO_EGP */
#ifdef IPPROTO_ENCAP
	if (x == IPPROTO_ENCAP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_ENCAP; return 0;}
#endif /* ndef IPPROTO_ENCAP */
#ifdef IPPROTO_ESP
	if (x == IPPROTO_ESP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_ESP; return 0;}
#endif /* ndef IPPROTO_ESP */
#ifdef IPPROTO_GRE
	if (x == IPPROTO_GRE)
		{*r = Mono_Posix_SockProtocol_IPPROTO_GRE; return 0;}
#endif /* ndef IPPROTO_GRE */
#ifdef IPPROTO_ICMP
	if (x == IPPROTO_ICMP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_ICMP; return 0;}
#endif /* ndef IPPROTO_ICMP */
#ifdef IPPROTO_IDP
	if (x == IPPROTO_IDP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_IDP; return 0;}
#endif /* ndef IPPROTO_IDP */
#ifdef IPPROTO_IGMP
	if (x == IPPROTO_IGMP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_IGMP; return 0;}
#endif /* ndef IPPROTO_IGMP */
#ifdef IPPROTO_IP
	if (x == IPPROTO_IP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_IP; return 0;}
#endif /* ndef IPPROTO_IP */
#ifdef IPPROTO_IPIP
	if (x == IPPROTO_IPIP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_IPIP; return 0;}
#endif /* ndef IPPROTO_IPIP */
#ifdef IPPROTO_IPV6
	if (x == IPPROTO_IPV6)
		{*r = Mono_Posix_SockProtocol_IPPROTO_IPV6; return 0;}
#endif /* ndef IPPROTO_IPV6 */
#ifdef IPPROTO_MTP
	if (x == IPPROTO_MTP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_MTP; return 0;}
#endif /* ndef IPPROTO_MTP */
#ifdef IPPROTO_PIM
	if (x == IPPROTO_PIM)
		{*r = Mono_Posix_SockProtocol_IPPROTO_PIM; return 0;}
#endif /* ndef IPPROTO_PIM */
#ifdef IPPROTO_PUP
	if (x == IPPROTO_PUP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_PUP; return 0;}
#endif /* ndef IPPROTO_PUP */
#ifdef IPPROTO_RAW
	if (x == IPPROTO_RAW)
		{*r = Mono_Posix_SockProtocol_IPPROTO_RAW; return 0;}
#endif /* ndef IPPROTO_RAW */
#ifdef IPPROTO_RSVP
	if (x == IPPROTO_RSVP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_RSVP; return 0;}
#endif /* ndef IPPROTO_RSVP */
#ifdef IPPROTO_SCTP
	if (x == IPPROTO_SCTP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_SCTP; return 0;}
#endif /* ndef IPPROTO_SCTP */
#ifdef IPPROTO_TCP
	if (x == IPPROTO_TCP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_TCP; return 0;}
#endif /* ndef IPPROTO_TCP */
#ifdef IPPROTO_TP
	if (x == IPPROTO_TP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_TP; return 0;}
#endif /* ndef IPPROTO_TP */
#ifdef IPPROTO_UDP
	if (x == IPPROTO_UDP)
		{*r = Mono_Posix_SockProtocol_IPPROTO_UDP; return 0;}
#endif /* ndef IPPROTO_UDP */
#ifdef IPPROTO_UDPLITE
	if (x == IPPROTO_UDPLITE)
		{*r = Mono_Posix_SockProtocol_IPPROTO_UDPLITE; return 0;}
#endif /* ndef IPPROTO_UDPLITE */
#ifdef SOL_SOCKET
	if (x == SOL_SOCKET)
		{*r = Mono_Posix_SockProtocol_SOL_SOCKET; return 0;}
#endif /* ndef SOL_SOCKET */
	errno = EINVAL; return -1;
}

int Mono_Posix_FromSockType (int x, int *r)
{
	*r = 0;
	if (x == Mono_Posix_SockType_SOCK_DCCP)
#ifdef SOCK_DCCP
		{*r = SOCK_DCCP; return 0;}
#else /* def SOCK_DCCP */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_DCCP */
	if (x == Mono_Posix_SockType_SOCK_DGRAM)
#ifdef SOCK_DGRAM
		{*r = SOCK_DGRAM; return 0;}
#else /* def SOCK_DGRAM */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_DGRAM */
	if (x == Mono_Posix_SockType_SOCK_PACKET)
#ifdef SOCK_PACKET
		{*r = SOCK_PACKET; return 0;}
#else /* def SOCK_PACKET */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_PACKET */
	if (x == Mono_Posix_SockType_SOCK_RAW)
#ifdef SOCK_RAW
		{*r = SOCK_RAW; return 0;}
#else /* def SOCK_RAW */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_RAW */
	if (x == Mono_Posix_SockType_SOCK_RDM)
#ifdef SOCK_RDM
		{*r = SOCK_RDM; return 0;}
#else /* def SOCK_RDM */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_RDM */
	if (x == Mono_Posix_SockType_SOCK_SEQPACKET)
#ifdef SOCK_SEQPACKET
		{*r = SOCK_SEQPACKET; return 0;}
#else /* def SOCK_SEQPACKET */
		{errno = EINVAL; return -1;}
#endif /* ndef SOCK_SEQPACKET */
	if (x == Mono_Posix_SockType_SOCK_STREAM)
#ifdef SOCK_STREAM
...
int Mono_Posix_ToSockType (int x, int *r)
{
	*r = 0;
	if (x == 0)
		return 0;
#ifdef SOCK_DCCP
	if (x == SOCK_DCCP)
		{*r = Mono_Posix_SockType_SOCK_DCCP; return 0;}
#endif /* ndef SOCK_DCCP */
#ifdef SOCK_DGRAM
	if (x == SOCK_DGRAM)
		{*r = Mono_Posix_SockType_SOCK_DGRAM; return 0;}
#endif /* ndef SOCK_DGRAM */
#ifdef SOCK_PACKET
	if (x == SOCK_PACKET)
		{*r = Mono_Posix_SockType_SOCK_PACKET; return 0;}
#endif /* ndef SOCK_PACKET */
#ifdef SOCK_RAW
	if (x == SOCK_RAW)
		{*r = Mono_Posix_SockType_SOCK_RAW; return 0;}
#endif /* ndef SOCK_RAW */
#ifdef SOCK_RDM
	if (x == SOCK_RDM)
		{*r = Mono_Posix_SockType_SOCK_RDM; return 0;}
#endif /* ndef SOCK_RDM */
#ifdef SOCK_SEQPACKET
	if (x == SOCK_SEQPACKET)
		{*r = Mono_Posix_SockType_SOCK_SEQPACKET; return 0;}
#endif /* ndef SOCK_SEQPACKET */
#ifdef SOCK_STREAM
	if (x == SOCK_STREAM)
		{*r = Mono_Posix_SockType_SOCK_STREAM; return 0;}
#endif /* ndef SOCK_STREAM */
	errno = EINVAL; return -1;
}
...
int
Mono_Posix_FromSockaddr (struct Mono_Posix_Sockaddr *from, struct sockaddr *to)
{

	memset (to, 0, sizeof(*to));

	if (Mono_Posix_FromAddrFamily (from->sa_family, &to->sa_family) != 0) {
		return -1;
	}

	return 0;
}
#endif /* ndef HAVE_STRUCT_SOCKADDR */


#ifdef HAVE_STRUCT_SOCKADDR
int
Mono_Posix_ToSockaddr (struct sockaddr *from, struct Mono_Posix_Sockaddr *to)
{

	memset (to, 0, sizeof(*to));

	if (Mono_Posix_ToAddrFamily (from->sa_family, &to->sa_family) != 0) {
		return -1;
	}
...
Mono_Posix_FromSockaddrIn (struct Mono_Posix_SockaddrIn *from, struct sockaddr_in *to)
{
	...
	if (Mono_Posix_FromAddrFamily (from->sin_family, &to->sin_family) != 0) {
		return -1;
	}
...
Mono_Posix_ToSockaddrIn (struct sockaddr_in *from, struct Mono_Posix_SockaddrIn *to)
{
	...
	if (Mono_Posix_ToAddrFamily (from->sin_family, &to->sin_family) != 0) {
		return -1;
	}
	to->sin_port   = from->sin_port;
...
Mono_Posix_FromSockaddrIn6 (struct Mono_Posix_SockaddrIn6 *from, struct sockaddr_in6 *to)
{
	...
	if (Mono_Posix_FromAddrFamily (from->sin6_family, &to->sin6_family) != 0) {
		return -1;
	}
...
Mono_Posix_ToSockaddrIn6 (struct sockaddr_in6 *from, struct Mono_Posix_SockaddrIn6 *to)
{
	...
	if (Mono_Posix_ToAddrFamily (from->sin6_family, &to->sin6_family) != 0) {
		return -1;
	}
	to->sin6_port     = from->sin6_port;
	to->sin6_flowinfo = from->sin6_flowinfo;
