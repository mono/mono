...
namespace System
{
    public sealed partial class TimeZoneInfo
    {
        ...
        private static TimeZoneInfo GetLocalTimeZoneFromTzFile()
        {
			...
			return (localTimeZoneFallback == null) ? Utc : localTimeZoneFallback;
#else
        ...
        private static string GetTimeZoneDirectory()
        {
            string tzDirectory;
#if (UNITY_AOT && FULL_AOT_RUNTIME) || UNITY_JIT
            tzDirectory = GetTimeZoneDirectoryUnity();
            if (!string.IsNullOrEmpty (tzDirectory))
                return tzDirectory;
#endif
            tzDirectory = Environment.GetEnvironmentVariable(TimeZoneDirectoryEnvironmentVariable);
