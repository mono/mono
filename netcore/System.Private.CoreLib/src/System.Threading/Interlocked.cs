...
namespace System.Threading
{
	public static class Interlocked
	{
		...
		extern static void CompareExchange_T (ref T location1, ref T value, ref T comparand, ref T result) where T : class?;
		...
		[MethodImplAttribute(MethodImplOptions.InternalCall)]
		[return: NotNullIfNotNull("location1")]
		extern static T Exchange_T (ref T location1, T value) where T : class?;
