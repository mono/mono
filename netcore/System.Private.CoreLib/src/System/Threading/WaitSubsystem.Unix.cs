...
namespace System.Threading
{
    ...
    internal static partial class WaitSubsystem
    {
		...
		static ThreadWaitInfo GetWaitInfo ()
		{
#if MONO
			// FIXME: Free it, abandon mutexes etc.
			if (Thread.CurrentThread.WaitInfo == null)
				Thread.CurrentThread.WaitInfo = new ThreadWaitInfo (Thread.CurrentThread);
#endif
			return Thread.CurrentThread.WaitInfo;
		}
        ...
        public static SafeWaitHandle NewMutex(bool initiallyOwned)
        {
            ...
            ThreadWaitInfo waitInfo = GetWaitInfo ();
            ...
            bool prioritize = false)
        {
            ...
            return waitableObject.Wait(GetWaitInfo (), timeoutMilliseconds, interruptible, prioritize);
        }
