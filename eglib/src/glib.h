...
guint      g_ptr_array_reserved_size      (GPtrArray *array);
...
gunichar2 *g_utf8_to_utf16 (const gchar *str, glong len, guint32 *items_read, guint32 *items_written, GError **err);
gunichar2 *eg_utf8_to_utf16_with_nuls (const gchar *str, glong len, guint32 *items_read, guint32 *items_written, GError **err);
