...
copy-targets:
	for p in net_2_0 net_3_5 net_4_0; do \
		cp $(XBUILD_DIR)/xbuild/Microsoft.Common.targets $(topdir)/class/lib/$$p; \
	...
	cp $(XBUILD_DIR)/xbuild/2.0/Microsoft.Common.tasks $(topdir)/class/lib/net_2_0
	cp $(XBUILD_DIR)/xbuild/3.5/Microsoft.Common.tasks $(topdir)/class/lib/net_3_5
	cp $(XBUILD_DIR)/xbuild/4.0/Microsoft.Common.tasks $(topdir)/class/lib/net_4_0
