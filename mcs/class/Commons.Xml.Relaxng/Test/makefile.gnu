...
LIBRARY = Mono.Xml.Relaxng_test.dll

LIB_LIST = Mono.Xml.Relaxng_test.args
LIB_FLAGS =	\
		-r $(topdir)/class/lib/corlib.dll \
		-r $(topdir)/class/lib/System.dll \
		-r $(topdir)/class/lib/Mono.Xml.Relaxng.dll \
...
run_test:
	-MONO_PATH=$(MONO_PATH) mono --debug $(NUNITCONSOLE) Mono.Xml.Relaxng_test.dll
