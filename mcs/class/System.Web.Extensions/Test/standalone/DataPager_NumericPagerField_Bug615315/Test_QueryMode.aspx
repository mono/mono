<%@ Page Title="Bug 615315, Query Mode" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" %>
						...
						<table runat="server">
							...
							<tr runat="server">
								<td runat="server" style="">
									<%= AppDomain.CurrentDomain.GetData ("BEGIN_CODE_MARKER") %><asp:DataPager ID="DataPager1" runat="server" PageSize="10" QueryStringField="pageNumber">
										<Fields>
