namespace System.Web.ModelBinding {
    ...
    internal static class Error {
        ...
        public static InvalidOperationException BindingBehavior_ValueNotFound(string fieldName) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.BindingBehavior_ValueNotFound),
                fieldName);
        ...
        public static ArgumentException Common_TypeMustImplementInterface(Type providedType, Type requiredInterfaceType, string parameterName) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.Common_TypeMustImplementInterface),
        ...
        public static ArgumentException GenericModelBinderProvider_ParameterMustSpecifyOpenGenericType(Type specifiedType, string parameterName) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.GenericModelBinderProvider_ParameterMustSpecifyOpenGenericType),
                specifiedType);
            return new ArgumentException(errorString, parameterName);
        }

        public static ArgumentException GenericModelBinderProvider_TypeArgumentCountMismatch(Type modelType, Type modelBinderType) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.GenericModelBinderProvider_TypeArgumentCountMismatch),
        ...
        public static InvalidOperationException ModelBinderProviderCollection_BinderForTypeNotFound(Type modelType) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.ModelBinderProviderCollection_BinderForTypeNotFound),
                modelType);
            return new InvalidOperationException(errorString);
        }
        ...
        public static ArgumentException ModelBinderUtil_ModelCannotBeNull(Type expectedType) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.ModelBinderUtil_ModelCannotBeNull),
                expectedType);
        ...
        public static ArgumentException ModelBinderUtil_ModelInstanceIsWrong(Type actualType, Type expectedType) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.ModelBinderUtil_ModelInstanceIsWrong),
        ...
        public static ArgumentException ModelBinderUtil_ModelMetadataCannotBeNull() {
            return new ArgumentException(System.Web.SR.GetString(System.Web.SR.ModelBinderUtil_ModelMetadataCannotBeNull), "bindingContext");
        }

        [SuppressMessage("Microsoft.Usage", "CA2208:InstantiateArgumentExceptionsCorrectly", Justification = "The purpose of this class is to throw errors on behalf of other methods")]
        public static ArgumentException ModelBinderUtil_ModelTypeIsWrong(Type actualType, Type expectedType) {
            string errorString = String.Format(CultureInfo.CurrentCulture, System.Web.SR.GetString(System.Web.SR.ModelBinderUtil_ModelTypeIsWrong),
                actualType, expectedType);
            return new ArgumentException(errorString, "bindingContext");
        }

        public static InvalidOperationException ModelBindingContext_ModelMetadataMustBeSet() {
            return new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.ModelBindingContext_ModelMetadataMustBeSet));
        }
