    ...
    public sealed class ProviderConnectionPointCollection : ReadOnlyCollectionBase {
        ...
        public ProviderConnectionPointCollection(ICollection connectionPoints) {
            ...
            foreach (object obj in connectionPoints) {
                ...
                if (point == null) {
                    throw new ArgumentException(System.Web.SR.GetString(System.Web.SR.Collection_InvalidType, "ProviderConnectionPoint"),
                                                "connectionPoints");
                }
                string id = point.ID;
                if (!_ids.Contains(id)) {
                    ...
                    throw new ArgumentException(System.Web.SR.GetString(System.Web.SR.WebPart_Collection_DuplicateID, "ProviderConnectionPoint", id), "connectionPoints");
                }
            }
        }
