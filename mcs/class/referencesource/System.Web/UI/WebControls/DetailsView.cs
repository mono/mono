...
namespace System.Web.UI.WebControls {
    ...
    public class DetailsView : CompositeDataBoundControl, IDataItemContainer, ICallbackContainer, ICallbackEventHandler, IPostBackEventHandler, IPostBackContainer, IDataBoundItemControl, IFieldControl {
        ...
        WebCategory("Paging"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.DetailsView_AllowPaging)
        ]
        ...
        WebSysDescription(System.Web.SR.DetailsView_AlternatingRowStyle)
        ]
        ...
        DefaultValue(false),
        WebSysDescription(System.Web.SR.DetailsView_AutoGenerateDeleteButton)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.DetailsView_AutoGenerateEditButton)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.DetailsView_AutoGenerateInsertButton)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(true),
        WebSysDescription(System.Web.SR.DetailsView_AutoGenerateRows)
        ]
        ...
        WebCategory("Layout"),
        DefaultValue(-1),
        WebSysDescription(System.Web.SR.DetailsView_CellPadding)
        ]
        ...
        WebCategory("Layout"),
        DefaultValue(0),
        WebSysDescription(System.Web.SR.DetailsView_CellSpacing)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.DetailsView_CommandRowStyle)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.DetailsView_DataKey)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.DetailsView_EnablePagingCallbacks)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.DetailsView_FieldHeaderStyle)
        ]
        ...
        PersistenceMode(PersistenceMode.InnerProperty),
        WebCategory("Default"),
        WebSysDescription(System.Web.SR.DetailsView_Fields)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.DetailsView_FooterStyle)
        ]
        ...
        PersistenceMode(PersistenceMode.InnerProperty),
        TemplateContainer(typeof(DetailsView)),
        WebSysDescription(System.Web.SR.DetailsView_FooterTemplate)
        ]
        ...
        DefaultValue(0),
        WebCategory("Data"),
        WebSysDescription(System.Web.SR.DetailsView_PageIndex)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.DetailsView_PagerSettings)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.DetailsView_Rows)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DetailsView_OnItemCommand)
        ]
        ...
        [
        WebCategory("Behavior"),
        WebSysDescription(System.Web.SR.DetailsView_OnItemCreated)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DetailsView_OnModeChanged)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DetailsView_OnModeChanging)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DetailsView_OnPageIndexChanged)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DetailsView_OnPageIndexChanging)
        ]
                ...
                if (dataSource != null) {
                    if (mode != DetailsViewMode.Insert) {
                        ...
                        if ((collection == null) && (pagedDataSource.IsPagingEnabled && !pagedDataSource.IsServerPagingEnabled)) {
                            throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_DataSourceMustBeCollection, ID));
                        }
        ...
        protected virtual void ExtractRowValues(IOrderedDictionary fieldValues, bool includeReadOnlyFields, bool includeKeys) {
            if (fieldValues == null) {
                System.Web.Util.Debug.Assert(false, "DetailsView::ExtractRowValues- must hand in a valid reference to an IDictionary.");
                return;
            }
        ...
        private void HandleInsert(string commandArg, bool causesValidation) {
            ...
            if (Mode != DetailsViewMode.Insert) {
                throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsViewFormView_ControlMustBeInInsertMode, "DetailsView", ID));
            }
        ...
        private void HandleUpdate(string commandArg, bool causesValidation) {
            ...
            if (Mode != DetailsViewMode.Edit) {
                throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsViewFormView_ControlMustBeInEditMode, "DetailsView", ID));
            }
        ...
        private bool LoadHiddenFieldState(string pageIndex, string dataKey) {
            ...
            if (PageIndex != oldPageIndex) {
                ...
                System.Web.Util.Debug.Assert(oldPageIndex >= 0, "Page indeces are out of sync from callback hidden field state");
        ...
        protected override void LoadViewState(object savedState) {            
            if (savedState != null) {
                ...
                if (myState[14] != null) {
                    System.Web.Util.Debug.Assert(RowsGeneratorInternal is IStateManager);
        ...
        protected virtual void OnItemDeleting(DetailsViewDeleteEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_UnhandledEvent, ID, "ItemDeleting"));
                }
            }
        }
        ...
        protected virtual void OnItemInserting(DetailsViewInsertEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_UnhandledEvent, ID, "ItemInserting"));
                }
            }
        }
        ...
        protected virtual void OnItemUpdating(DetailsViewUpdateEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_UnhandledEvent, ID, "ItemUpdating"));
                }
            }
        }
        ...
        protected virtual void OnModeChanging(DetailsViewModeEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_UnhandledEvent, ID, "ModeChanging"));
                }
            }
        }
        ...
        protected virtual void OnPageIndexChanging(DetailsViewPageEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_UnhandledEvent, ID, "PageIndexChanging"));
                }
            }
        }
...
{0}.callback = function(arg) {{
    {2};
        ...
        protected virtual void RaiseCallbackEvent(string eventArgument) {
            ...
            System.Web.Util.Debug.Assert((arguments != null && (arguments.Length == 4)), "An unexpected number of params came through");
        ...
        private void Render(HtmlTextWriter writer, bool renderPanel) {
            ...
            if (renderPanel) {
                if (DetermineRenderClientScript()) {
                    ...
                    if (clientID == null) {
                        throw new HttpException(System.Web.SR.GetString(System.Web.SR.DetailsView_MustBeParented));
                    }
                    else {
