    ...
    public class DetailsViewRowsGenerator : AutoFieldsGenerator {
        ...
        public override List<AutoGeneratedField> CreateAutoGeneratedFields(object dataItem, Control control) {
            if (!(control is DetailsView)) {
                throw new ArgumentException(System.Web.SR.GetString(System.Web.SR.InvalidDefaultAutoFieldGenerator, GetType().FullName, typeof(DetailsView).FullName));
            }
            ...
            if ((generatedFields.Count == 0) && throwException) {
                ...
                throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.DetailsView_NoAutoGenFields, detailsView.ID));
            }
