...
namespace System.Web.UI.WebControls {
    ...
    public class GridView : CompositeDataBoundControl, IPostBackContainer, IPostBackEventHandler, ICallbackContainer,
        ...
        WebCategory("Paging"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AllowCustomPaging)
        ]
        ...
        WebCategory("Paging"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AllowPaging)
        ]
        ...
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AllowSorting)
        ]
        ...
        WebSysDescription(System.Web.SR.GridView_AlternatingRowStyle)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AutoGenerateDeleteButton)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AutoGenerateEditButton)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_AutoGenerateSelectButton)
        ]
        ...
        WebCategory("Layout"),
        DefaultValue(-1),
        WebSysDescription(System.Web.SR.GridView_CellPadding)
        ]
        ...
        WebCategory("Layout"),
        DefaultValue(0),
        WebSysDescription(System.Web.SR.GridView_CellSpacing)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_DataKeys)
        ]
        ...
        WebCategory("Default"),
        DefaultValue(-1),
        WebSysDescription(System.Web.SR.GridView_EditIndex)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_EditRowStyle)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_EnablePersistedSelection)
        ]
        ...
        WebCategory("Behavior"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_EnableSortingAndPagingCallbacks)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_EmptyDataRowStyle)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_PageCount)
        ]
        ...
        DefaultValue(0),
        WebCategory("Paging"),
        WebSysDescription(System.Web.SR.GridView_PageIndex)
        ]
        ...
        WebCategory("Paging"),
        DefaultValue(10),
        WebSysDescription(System.Web.SR.GridView_PageSize),
        ]
        ...
        WebCategory("Accessibility"),
        WebSysDescription(System.Web.SR.GridView_RowHeaderColumn)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_Rows)
        ]
        ...
        public virtual DataKey SelectedDataKey {
            get {
                if (DataKeyNamesInternal == null || DataKeyNamesInternal.Length == 0) {
                    throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.GridView_DataKeyNamesMustBeSpecified, ID));
                }
        ...
        Bindable(true),
        DefaultValue(-1),
        WebSysDescription(System.Web.SR.GridView_SelectedIndex)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_SelectedRow)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SelectedRowStyle)
        ]
        ...
        WebCategory("Appearance"),
        DefaultValue(false),
        WebSysDescription(System.Web.SR.GridView_ShowHeaderWhenEmpty)
        ]
        ...
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SortDirection)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_SortExpression)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SortedAscendingCellStyle)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SortedAscendingHeaderStyle)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SortedDescendingCellStyle)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.GridView_SortedDescendingHeaderStyle)
        ]
        ...
        Browsable(false),
        DesignerSerializationVisibility(DesignerSerializationVisibility.Hidden),
        WebSysDescription(System.Web.SR.GridView_VirtualItemCount)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.DataControls_OnRowDeleted)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnRowCancelingEdit)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnRowEditing)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnPageIndexChanged)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnPageIndexChanging)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnSelectedIndexChanged)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnSelectedIndexChanging)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnSorted)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnSorting)
        ]
        ...
        [
        WebCategory("Action"),
        WebSysDescription(System.Web.SR.GridView_OnRowCommand)
        ]
        ...
        [
        WebCategory("Behavior"),
        WebSysDescription(System.Web.SR.GridView_OnRowCreated)
        ]
        ...
        [
        WebCategory("Data"),
        WebSysDescription(System.Web.SR.GridView_OnRowDataBound)
        ]
        ...
        protected override int CreateChildControls(IEnumerable dataSource, bool dataBinding) {
            ...
            if (dataBinding) {
                ...
                if (dataSource != null) {
                    ...
                    if ((collection == null) && (pagedDataSource.IsPagingEnabled && !pagedDataSource.IsServerPagingEnabled)) {
                        throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_Missing_VirtualItemCount, ID));
                    }
                }
            }
            else {
            ...
            if (dataSource != null) {
                ...
                if (pagedDataSource.IsPagingEnabled && dataBinding) {
                    ...
                    System.Web.Util.Debug.Assert(pagedDataSource.CurrentPageIndex >= 0);
        ...
        private bool DetermineRenderClientScript() {
            ...
            if (!_renderClientScriptValid) {
                ...
                if (EnableSortingAndPagingCallbacks && (Context != null) && (Page != null) && (Page.RequestInternal != null) && Page.Request.Browser.SupportsCallback && !IsParentedToUpdatePanel) {
                    ...
                    bool isHtml4 = !System.Web.Util.StringUtil.EqualsIgnoreCase(browserCaps["tagwriter"], typeof(Html32TextWriter).FullName);
        ...
        protected virtual void ExtractRowValues(IOrderedDictionary fieldValues, GridViewRow row, bool includeReadOnlyFields, bool includePrimaryKey) {
            if (fieldValues == null) {
                System.Web.Util.Debug.Assert(false, "GridView::ExtractRowValues- must hand in a valid reference to an IDictionary.");
                return;
            }
        ...
        private void HandleDelete(GridViewRow row, int rowIndex) {
            ...
            if (isBoundToDataSourceControl) {
                view = GetData();
                if (view == null) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_DataSourceReturnedNullView, ID));
                }
            }
        ...
        private bool HandleDeleteCallback(int affectedRows, Exception ex) {
            ...
            if (affectedRows > 0) {
                ...
                if (AllowPaging) {
                    ...
                    System.Web.Util.Debug.Assert(_pageIndex >= 0, "Page index should never be negative!");
                }
        ...
        private bool HandleEvent(EventArgs e, bool causesValidation, string validationGroup) {
            ...
            if (dce != null) {
                ...
                if (System.Web.Util.StringUtil.EqualsIgnoreCase(command, DataControlCommands.SelectCommandName)) {
                    HandleSelect(GetRowIndex(dce.Row, (string)dce.CommandArgument));
                }
                else if (System.Web.Util.StringUtil.EqualsIgnoreCase(command, DataControlCommands.PageCommandName)) {
                    string pageNumberArg = (string)dce.CommandArgument;

                    int newPage = PageIndex;

                    if (System.Web.Util.StringUtil.EqualsIgnoreCase(pageNumberArg, DataControlCommands.NextPageCommandArgument)) {
                        newPage++;
                    }
                    else if (System.Web.Util.StringUtil.EqualsIgnoreCase(pageNumberArg, DataControlCommands.PreviousPageCommandArgument)) {
                        newPage--;
                    }
                    else if (System.Web.Util.StringUtil.EqualsIgnoreCase(pageNumberArg, DataControlCommands.FirstPageCommandArgument)) {
                        newPage = 0;
                    }
                    else if (System.Web.Util.StringUtil.EqualsIgnoreCase(pageNumberArg, DataControlCommands.LastPageCommandArgument)) {
                        newPage = PageCount - 1;
                    }
                    else {
                ...
                else if (System.Web.Util.StringUtil.EqualsIgnoreCase(command, DataControlCommands.SortCommandName)) {
        ...
        protected override void LoadViewState(object savedState) {
            if (savedState != null) {
                ...
                if (myState[12] != null) {
                    System.Web.Util.Debug.Assert(ColumnsGeneratorInternal is IStateManager);
        ...
        protected virtual void OnPageIndexChanging(GridViewPageEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "PageIndexChanging"));
                }
            }
        }
    ...
    {2};
        ...
        protected virtual void OnRowCancelingEdit(GridViewCancelEditEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "RowCancelingEdit"));
                }
            }
        }
        ...
        protected virtual void OnRowDeleting(GridViewDeleteEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "RowDeleting"));
                }
            }
        }
        ...
        protected virtual void OnRowEditing(GridViewEditEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "RowEditing"));
                }
            }
        }
        ...
        protected virtual void OnRowUpdating(GridViewUpdateEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "RowUpdating"));
                }
            }
        }
        ...
        protected virtual void OnSorting(GridViewSortEventArgs e) {
            ...
            if (handler != null) {
                ...
                if (isBoundToDataSourceControl == false && e.Cancel == false) {
                    throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_UnhandledEvent, ID, "Sorting"));
                }
            }
        }
        ...
        protected internal override void PerformDataBinding(IEnumerable data) {
            ...
            if (EnablePersistedSelection) {
                ...
                if ((keyNames == null) || (keyNames.Length == 0)) {
                    throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.GridView_PersistedSelectionRequiresDataKeysNames));
                }
            }
        ...
        protected virtual void RaiseCallbackEvent(string eventArgument) {
            ...
            System.Web.Util.Debug.Assert((arguments != null && (arguments.Length == 8)), "An unexpected number of params came through on " + eventArgument);
            IStateFormatter2 formatter = StateFormatter;
        ...
        private void Render(HtmlTextWriter writer, bool renderPanel) {
            ...
            if (renderPanel) {
                ...
                if (DetermineRenderClientScript()) {
                    if (clientID == null) {
                        throw new HttpException(System.Web.SR.GetString(System.Web.SR.GridView_MustBeParented));
                    }
                    else {
        ...
        private void SelectCallback(IEnumerable data) {
            ...
            throw new HttpException(System.Web.SR.GetString(System.Web.SR.DataBoundControl_DataSourceDoesntSupportPaging, DataSourceID));
        }
