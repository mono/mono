    ...
    public class GridViewColumnsGenerator : AutoFieldsGenerator {
        ...
        public override List<AutoGeneratedField> CreateAutoGeneratedFields(object dataObject, Control control) {
            if (!(control is GridView)) {
                throw new ArgumentException(System.Web.SR.GetString(System.Web.SR.InvalidDefaultAutoFieldGenerator, GetType().FullName, typeof(GridView).FullName));
            }

            System.Web.Util.Debug.Assert(dataObject == null || dataObject is PagedDataSource);
            ...
            if ((generatedFields.Count == 0) && throwException) {
                ...
                throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.GridView_NoAutoGenFields, gridView.ID));
            }
