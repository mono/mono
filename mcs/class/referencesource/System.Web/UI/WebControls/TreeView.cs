...
";
        ...
        WebSysDescription(System.Web.SR.TreeView_AutoGenerateDataBindings)
        ]
        ...
        WebCategory("Data"),
        WebSysDescription(System.Web.SR.TreeView_DataBindings)
        ]
        ...
        /// </devdoc>
        [Localizable(true)]
        [WebSysDefaultValue(System.Web.SR.TreeView_CollapseImageToolTipDefaultValue)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_CollapseImageToolTip)]
        public string CollapseImageToolTip {
            get {
                string s = (string)ViewState["CollapseImageToolTip"];

                if (s == null) {
                    return System.Web.SR.GetString(System.Web.SR.TreeView_CollapseImageToolTipDefaultValue);
                }
        ...
        [UrlProperty()]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_CollapseImageUrl)]
        ...
        [WebCategory("Behavior")]
        [Themeable(false)]
        [WebSysDescription(System.Web.SR.TreeView_EnableClientScript)]
        ...
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_ExpandDepth)]
        ...
        /// </devdoc>
        [Localizable(true)]
        [WebSysDefaultValue(System.Web.SR.TreeView_ExpandImageToolTipDefaultValue)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_ExpandImageToolTip)]
        public string ExpandImageToolTip {
            get {
                string s = (string)ViewState["ExpandImageToolTip"];

                if (s == null) {
                    return System.Web.SR.GetString(System.Web.SR.TreeView_ExpandImageToolTipDefaultValue);
                }
        ...
        [UrlProperty()]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_ExpandImageUrl)]
        ...
        PersistenceMode(PersistenceMode.InnerProperty),
        WebCategory("Styles"),
        WebSysDescription(System.Web.SR.TreeView_HoverNodeStyle)
        ]
        ...
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_ImageSet)]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_LeafNodeStyle)
        ]
        ...
        PersistenceMode(PersistenceMode.InnerProperty),
        WebCategory("Styles"),
        WebSysDescription(System.Web.SR.TreeView_LevelStyles),
        ]
        ...
        [DefaultValue("")]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_LineImagesFolderUrl)]
        ...
        [WebCategory("Behavior")]
        [DefaultValue(-1)]
        [WebSysDescription(System.Web.SR.TreeView_MaxDataBindDepth)]
        ...
        [UrlProperty()]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_NoExpandImageUrl)]
        ...
        [DefaultValue(20)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_NodeIndent)]
        ...
        [DefaultValue(false)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_NodeWrap)]
        ...
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_Nodes)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_NodeStyle)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_ParentNodeStyle)
        ]
        ...
        /// </devdoc>
        [DefaultValue('/')]
        [WebSysDescription(System.Web.SR.TreeView_PathSeparator)]
        ...
        [DefaultValue(true)]
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_PopulateNodesFromClient)]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_RootNodeStyle)
        ]
        ...
        NotifyParentProperty(true),
        PersistenceMode(PersistenceMode.InnerProperty),
        WebSysDescription(System.Web.SR.TreeView_SelectedNodeStyle)
        ]
        ...
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_ShowCheckBoxes)]
        ...
        [DefaultValue(true)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_ShowExpandCollapse)]
        ...
        [DefaultValue(false)]
        [WebCategory("Appearance")]
        [WebSysDescription(System.Web.SR.TreeView_ShowLines)]
        ...
        WebSysDefaultValue(System.Web.SR.TreeView_Default_SkipLinkText),
        WebSysDescription(System.Web.SR.TreeView_SkipLinkText)
        ]
        public String SkipLinkText {
            get {
                string s = ViewState["SkipLinkText"] as String;
                return s == null ? System.Web.SR.GetString(System.Web.SR.TreeView_Default_SkipLinkText) : s;
            }
            set {
        ...
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_CheckChanged)]
        ...
        /// </devdoc>
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_SelectedNodeChanged)]
        ...
        /// </devdoc>
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_TreeNodeCollapsed)]
        ...
        /// </devdoc>
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_TreeNodeDataBound)]
        ...
        /// </devdoc>
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_TreeNodeExpanded)]
        ...
        /// </devdoc>
        [WebCategory("Behavior")]
        [WebSysDescription(System.Web.SR.TreeView_TreeNodePopulate)]
        ...
        private void DataBindNode(TreeNode node) {
            if (node.PopulateOnDemand && !IsBoundUsingDataSourceID && !DesignMode) {
                throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_PopulateOnlyForDataSourceControls, ID));
            }
            ...
            if (view == null) {
                throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_DataSourceReturnedNullView, ID));
            }
                ...
                if (level != null) {
                    ...
                    if (textField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, textField, "TextField"));
                        }
                    }
                    ...
                    if (valueField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, valueField, "ValueField"));
                        }
                    }
                    ...
                    if (imageUrlField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, imageUrlField, "ImageUrlField"));
                        }
                    }
                    ...
                    if (navigateUrlField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, navigateUrlField, "NavigateUrlField"));
                        }
                    }
                    ...
                    if (targetField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, targetField, "TargetField"));
                        }
                    }
                    ...
                    if (toolTipField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, toolTipField, "ToolTipField"));
                        }
                    }
                    ...
                    if (imageToolTipField.Length > 0) {
                        ...
                        if (desc != null) {
                            ...
                            throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.TreeView_InvalidDataBinding, imageToolTipField, "imageToolTipField"));
                        }
                    }
        ...
        private void EnsureRenderSettings() {
            ...
            if (_hoverNodeStyle != null && Page != null && Page.Header == null) {
                throw new InvalidOperationException(System.Web.SR.GetString(System.Web.SR.NeedHeader, "TreeView.HoverStyle"));
            }
                ...
                switch (index) {
                    ...
                    case NoExpandImageIndex:
                        if (ShowLines) {
                            if (LineImagesFolder.Length == 0) {
                                ...
                                ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "noexpand.gif"));
                            }
                        }
                        else {
                    ...
                    case PlusImageIndex:
                        if (ShowLines) {
                            if (LineImagesFolder.Length == 0) {
                                ...
                                ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "plus.gif"));
                            }
                        }
                        else {
                    ...
                    case MinusImageIndex:
                        if (ShowLines) {
                            if (LineImagesFolder.Length == 0) {
                                ...
                                ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "minus.gif"));
                            }
                        }
                        else {
                    ...
                    case IImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "i.gif"));
                        }
                        break;
                    case RImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "r.gif"));
                        }
                        break;
                    case RPlusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "rplus.gif"));
                        }
                        break;
                    case RMinusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "rminus.gif"));
                        }
                        break;
                    case TImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "t.gif"));
                        }
                        break;
                    case TPlusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "tplus.gif"));
                        }
                        break;
                    case TMinusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "tminus.gif"));
                        }
                        break;
                    case LImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "l.gif"));
                        }
                        break;
                    case LPlusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "lplus.gif"));
                        }
                        break;
                    case LMinusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "lminus.gif"));
                        }
                        break;
                    case DashImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "dash.gif"));
                        }
                        break;
                    case DashPlusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "dashplus.gif"));
                        }
                        break;
                    case DashMinusImageIndex:
                        if (LineImagesFolder.Length == 0) {
                            ...
                            ImageUrls[index] = ResolveClientUrl(System.Web.Util.UrlPath.SimpleCombine(LineImagesFolder, "dashminus.gif"));
                        }
                        break;
                }
            }
        ...
        private bool GetRenderClientScript(HttpBrowserCapabilities caps) {
            return (EnableClientScript &&
                    ...
                    (caps.W3CDomVersion.Major > 0) &&
                     !System.Web.Util.StringUtil.EqualsIgnoreCase(caps["tagwriter"], typeof(Html32TextWriter).FullName));
        }
