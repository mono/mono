...
namespace System.Xml.Xsl
{
    ...
    public sealed class XslCompiledTransform
    {
        ...
        private System.Xml.Xsl.Xslt.CompilerErrorCollection _compilerErrorColl = null;
        ...
        private System.Xml.Xsl.Xslt.CompilerErrorCollection LoadInternal(object stylesheet, XsltSettings settings, XmlResolver stylesheetResolver)
        {
            if (stylesheet == null)
            {
            ...
            System.Xml.Xsl.Xslt.CompilerError error = GetFirstError();
            if (error != null)
            {
        ...
        /// </summary>
        private System.Xml.Xsl.Xslt.CompilerError GetFirstError()
        {
            foreach (System.Xml.Xsl.Xslt.CompilerError error in _compilerErrorColl)
            {
                if (!error.IsWarning)
                {
                    return error;
