...
{
    public class DynamicDataSourceView : DataSourceView
    {
        ...
        public IDynamicDataContainer DataContainerInstance
        {
            get
            {
                ...
                if (inst != null) {
                    dataContainer = inst as IDynamicDataContainer;
                    if (inst == null)
                        throw new InvalidOperationException (
                            "DynamicDataSource.DataContainerInstance must be set to an instance of IDynamicDataContainer.");
                    return dataContainer;
                }
                ...
                if (!typeof (IDynamicDataContainer).IsAssignableFrom (type))
                ...
                dataContainer = Activator.CreateInstance (type) as IDynamicDataContainer;
                if (dataContainer == null)
