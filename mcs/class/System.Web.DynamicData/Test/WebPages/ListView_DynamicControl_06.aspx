<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListView_DynamicControl_06.aspx.cs" Inherits="ListView_DynamicControl_06" %>
...
<body>
    ...
    <div>
      ...
      <asp:ListView ID="ListView1" runat="server" DataSourceID="DynamicDataSource1">
        ...
        <ItemTemplate>
	<div>
		<test:PokerDynamicControl runat="server" DataField="NoSuchColumn" id="FirstName"/> 
