<%@ Page Language="C#" AutoEventWireup="true" CodeFile="ListView_DynamicControl_05.aspx.cs" Inherits="ListView_DynamicControl_05" %>
...
<body>
    ...
    <div>
      ...
      <asp:ListView ID="ListView1" runat="server" DataSourceID="DynamicDataSource1">
        ...
        <ItemTemplate>
	<div>
		<test:PokerDynamicControl runat="server" DataField="" id="FirstName"/> 
