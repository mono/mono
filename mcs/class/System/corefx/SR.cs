...
partial class SR
{
	...
	public const string net_FailedToParseNetworkFile = "An error was encountered while parsing network information from the operating system.";
	public const string net_InformationUnavailableOnPlatform = "The information requested in unavailable on the current platform.";
	...
	public const string net_NoLoopback = "No loopback interface was found on the local machine.";
	public const string net_noseek = "This stream does not support seek operations.";
	public const string net_PInvokeError = "An error was encountered while querying information from the operating system.";
