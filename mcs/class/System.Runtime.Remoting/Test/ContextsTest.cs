		...
		public static string[] seqRemoteContext =
			{
				...
				"014 (d2,c1) List created",
				"015 (d2,c1) IContributeEnvoySink(1.d1).GetEnvoySink",
				"016 (d2,c1) IContributeEnvoySink(x.d1).GetEnvoySink",
				"017 (d2,c1) IContributeEnvoySink(x.d2).GetEnvoySink",
