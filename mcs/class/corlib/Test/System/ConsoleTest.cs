...
public class ConsoleTest
{
	...
	public void TestStandardInputStream ()
	{
		...
		Assert.IsTrue (s.CanRead, "#A1");
		Assert.IsFalse (s.CanWrite, "#A2");
		Assert.IsFalse (s.CanSeek, "#A3");
		Assert.IsFalse (s.CanTimeout, "#A4");
	}

	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardInputStreamNoSeek ()
	{
		Stream s = Console.OpenStandardInput ();
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardInputStreamNoLength ()
	{
		Stream s = Console.OpenStandardInput ();
		long l = s.Length;
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardInputStreamNoPosition ()
	{
		Stream s = Console.OpenStandardInput ();
		long l = s.Position;
	}
	...
	public void TestStandardOutputStream ()
	{
		...
		Assert.IsFalse (s.CanRead, "#A1");
		Assert.IsTrue (s.CanWrite, "#A2");
		Assert.IsFalse (s.CanSeek, "#A3");
		Assert.IsFalse (s.CanTimeout, "#A4");
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardOutputStreamNoSeek ()
	{
		Stream s = Console.OpenStandardOutput ();
		s.Seek (0, SeekOrigin.Begin);
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardOutputStreamNoLength ()
	{
		Stream s = Console.OpenStandardOutput ();
		long l = s.Length;
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardOutputStreamNoPosition ()
	{
		Stream s = Console.OpenStandardOutput ();
		long l = s.Position;
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardErrorStreamNoSeek ()
	{
		Stream s = Console.OpenStandardError ();
		s.Seek (0, SeekOrigin.Begin);
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardErrorStreamNoLength ()
	{
		Stream s = Console.OpenStandardError ();
		long l = s.Length;
	}
	...
	[Test]
	[ExpectedException (typeof (NotSupportedException))]
	public void TestStandardErrorStreamNoPosition ()
	{
		Stream s = Console.OpenStandardError ();
		long l = s.Position;
	}
