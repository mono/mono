...
public void Certificate9 ()
{
	...
	AssertEquals ("GetSerialNumber", serial, x509.GetSerialNumber ());
	Assertion.AssertEquals ("GetSerialNumberString", "443470B934C6DEB763B0C4CE5E350B20", x509.GetSerialNumberString ());
...
public void Certificate12 ()
{
	...
	AssertEquals ("GetSerialNumber", serial, x509.GetSerialNumber ());
	Assertion.AssertEquals ("GetSerialNumberString", "34000000000043110761", x509.GetSerialNumberString ());
...
//	Assertion.Assert ("Equals", disk.Equals (clone));
	...
	Assertion.AssertEquals ("GetEffectiveDateString", "04/19/2001 06:57:20", x509.GetEffectiveDateString ());
	Assertion.AssertEquals ("GetExpirationDateString", "04/19/2011 06:57:20", x509.GetExpirationDateString ());
	Assertion.AssertEquals ("GetFormat", "X509", x509.GetFormat ());
