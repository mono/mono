...
[TestFixture]
public class AssemblyNameTest : Assertion {
	...
	public void TestCultureInfo ()
	{
		...
		AssertEquals (a.GetName ().CultureInfo.Name, "ar-DZ");
	}
	...
	public void TestVersion ()
	{
		...
		Assembly a = GenerateAssembly (name);
		AssertEquals (a.GetName ().Version.ToString (), "1.2.3.4");

		name = GenAssemblyName ();
		name.Version = new Version (1, 2, 3);

		a = GenerateAssembly (name);
		AssertEquals (a.GetName ().Version.ToString (), "1.2.3.0");

		name = GenAssemblyName ();
		name.Version = new Version (1, 2);

		a = GenerateAssembly (name);
		AssertEquals (a.GetName ().Version.ToString (), "1.2.0.0");
	}

	public void TestHashAlgorithm ()
	{
		AssertEquals (typeof (int).Assembly.GetName ().HashAlgorithm,
