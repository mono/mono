...
public class StrongNameTest : TestCase {
	...
	public StrongNameTest () : base ("System.Security.Policy.StrongName testsuite") {}
	public StrongNameTest (string name) : base (name) {}
	...
	public static ITest Suite {
		get { 
			return new TestSuite (typeof (StrongNameTest)); 
		}
	}
