...
partial class SR
{
	...
	public const string Argument_AddingDuplicate_OldAndNewKeys  = "Item has already been added. Key in dictionary: '{0}'  Key being added: '{1}'";
	...
	public const string InvalidArgumentValue = "Value of '{1}' is not valid for '{0}'.";
	...
	public const string UnauthorizedAccess_IODenied_NoPortName = "Access to the port is denied.";
	public const string IO_PathTooLong_PortName = "The specified port name is too long.  The port name must be less than 260 characters.";
	public const string IO_SharingViolation_NoPortName = "The process cannot access the port because it is being used by another process.";
	public const string IO_SharingViolation_Port = "The process cannot access the port '{0}' because it is being used by another process.";
	public const string UnauthorizedAccess_IODenied_Port = "Access to the port '{0}' is denied.";
	...
	public const string IO_PathTooLong_Path_PortName = "The specified port name '{0}' is too long.  The port name must be less than 260 characters.";
	...
	public const string NotSupported_Platform = "Not supported on this platform.";
	...
	public const string Cryptography_AlgKdfRequiresChars = "The KDF for algorithm '{0}' requires a char-based password input.";
	...
	public const string Cryptography_Cms_Ktri_RSARequired = "An RSA key is required to decrypt for a RecipientInfo with a KeyTransport recipient type.";
	...
	public const string Cryptography_Pkcs12_CannotProcessEncryptedSafeContents = "This operation is not valid on an encrypted or enveloped Pkcs12SafeContents.";
	public const string Cryptography_Pkcs12_CertBagNotX509 = "The Pkcs12CertBag contents are not an X.509 certificate.";
	public const string Cryptography_Pkcs12_PfxIsSealed = "The Pkcs12Builder can no longer be modified because one of the Seal methods was already invoked.";
	public const string Cryptography_Pkcs12_PfxMustBeSealed = "One of the Seal methods must be invoked on the Pkcs12Builder before invoking an Encode method.";
	public const string Cryptography_Pkcs12_SafeContentsIsEncrypted = "Cannot enumerate the contents of an encrypted or enveloped Pkcs12SafeContents.";
	public const string Cryptography_Pkcs12_SafeContentsIsReadOnly = "New Pkcs12SafeBag values cannot be added to a Pkcs12SafeContents that was read from existing data.";
	public const string Cryptography_Pkcs12_WrongModeForDecrypt = "This decryption operation applies to 'Pkcs12ConfidentialityMode.{0}', but the target object is in 'Pkcs12ConfidentialityMode.{1}'.";
	public const string Cryptography_Pkcs12_WrongModeForVerify = "This verification operation applies to 'Pkcs12IntegrityMode.{0}', but the target object is in 'Pkcs12IntegrityMode.{1}'.";
	public const string Cryptography_Pkcs_InvalidSignatureParameters = "Invalid signature paramters.";
	public const string Cryptography_Pkcs8_EncryptedReadFailed = "The EncryptedPrivateKeyInfo structure was decoded but was not successfully interpreted, the password may be incorrect.";
	...
	public const string Cryptography_UnknownAlgorithmIdentifier = "The algorithm identified by '{0}' is unknown, not valid for the requested usage, or was not handled.";
	...
	public const string Cryptography_Cms_NoAttributeFound = "Attribute not found.";
	public const string Cryptography_Cms_NoCertificateFound = "Certificate not found.";
	public const string Cryptography_Cms_CertificateAlreadyInCollection = "Certificate already present in the collection.";
	...
	public const string InternalError_ScanRegex = "Internal error in ScanRegex.";
