...
{	
	...
	public static void Main () 
	{
		...
		/* First */		
		Rectangle rect1 = new Rectangle (20, 30, 60, 80);		
		Rectangle rect2 = new Rectangle (50, 40, 60, 80);		
		...
		/* Second */		
		Rectangle rect3 = new Rectangle (130, 30, 60, 80);		
		Rectangle rect4 = new Rectangle (170, 40, 60, 80);		
		Region rgn3 = new Region (rect3);
		Region rgn4 = new Region (rect4);			
