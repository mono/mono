...
namespace Microsoft.VisualBasic
{
	...
	internal class VisualBasicCodeCompiler: VisualBasicCodeGenerator, ICodeCompiler
	{
		//
		// Constructors
		//
		public VisualBasicCodeCompiler()
		{
		}
			...
			CompilerParameters options,CodeCompileUnit[] ea)
		{
			...
			{
				fileNames[i]=Path.ChangeExtension(Path.GetTempFileName(),"vb");
