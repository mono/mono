...
//
// Taken from CoreFX, merges UnixDomainSocketEndPoint.cs and UnixDomainSocketEndPoint.Unix.cs
// and makes the class internal.
...
namespace System.Net.Sockets
{
	...
	sealed class UnixDomainSocketEndPoint : EndPoint
	{
		...
		{
			SocketAddress result = new SocketAddress(AddressFamily.Unix, s_nativePathOffset + _encodedPath.Length);
