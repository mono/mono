...
DESCRIPTION = "var tostr=Boolean.prototype.toString; x=new String( 'hello' ); x.toString=tostr; x.toString()";
EXPECTED = "error";

new TestCase(   SECTION,
		"var tostr=Boolean.prototype.toString; x=new String( 'hello' ); x.toString=tostr; x.toString()",
		"error",
		eval("var tostr=Boolean.prototype.toString; x=new String( 'hello' ); x.toString=tostr; x.toString()") );
