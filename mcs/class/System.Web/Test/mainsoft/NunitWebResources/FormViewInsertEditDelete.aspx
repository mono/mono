...
<script runat="server">
    ...
    protected void Page_Load (object sender, EventArgs e)
    {
        FormView1.DataKeyNames = new string[] { "ID" };
         if (!IsPostBack)  
            MonoTests.System.Web.UI.WebControls.DataObject.ds = MonoTests.System.Web.UI.WebControls.DataObject.CreateDataTable ();                       
    }    
    ...
    <div>
        ...
        <asp:FormView ID="FormView1" runat="server" AllowPaging="True" DataSourceID="ObjectDataSource1"  >
            ...
            <EditItemTemplate>                
                ...
                <asp:LinkButton ID="CancelUpdateButton" runat="server" CommandName='<%# "Cancel" %>' Text='<%# "Cancel" %>'></asp:LinkButton>
            </EditItemTemplate>
            <InsertItemTemplate>
                Insert ID:
                ...
                <asp:LinkButton ID="CancelInsertButton" runat="server" CommandName='<%# "Cancel" %>' Text='<%# "Cancel" %>'></asp:LinkButton>
            </InsertItemTemplate>
            <EmptyDataTemplate>
        ...
        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DeleteMethod="Delete"
            InsertMethod="Insert" SelectMethod="Select" TypeName="MonoTests.System.Web.UI.WebControls.DataObject"
            UpdateMethod="Update">
            <DeleteParameters>
