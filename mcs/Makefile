...
net_2_0_SUBDIRS := build tools/resgen class nunit24 ilasm tools tests errors
moonlight_raw_SUBDIRS := build class
monodroid_SUBDIRS := build class
monotouch_SUBDIRS := build class
net_3_5_SUBDIRS := build class tools/xbuild
net_4_0_SUBDIRS := build mcs tools/resgen class nunit24 ilasm tools tests errors docs
