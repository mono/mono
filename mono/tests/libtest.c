...
static void marshal_bstr_free(gunichar2* bstr)
{
#ifdef WIN32
	SysFreeString (bstr);
#else
...
static GUID IID_IMonoRecordInfo = {0x0000002f, 0, 0, {0xc0,0,0,0,0,0,0,0x46}};
...
{
	int (STDCALL *QueryInterface)(MonoIRecordInfo* pRecInfo, gpointer riid, gpointer* ppv);
...
static int STDCALL
MonoIRecordInfoQueryInterface(MonoIRecordInfo* pRecInfo, gpointer riid, gpointer* ppv)
{
	*ppv = NULL;
	if (!memcmp(riid, &IID_IMonoUnknown, sizeof(GUID)) || !memcmp(riid, &IID_IMonoRecordInfo, sizeof(GUID))) {
		*ppv = pRecInfo;
		return S_OK;
	}
	return 0x80004002;
...
static int STDCALL
MonoIRecordInfoAddRef(MonoIRecordInfo* pRecInfo)
{
	return 2;
}

static int STDCALL
MonoIRecordInfoRelease(MonoIRecordInfo* pRecInfo)
{
	return 1;
}

static int STDCALL
MonoIRecordInfoRecordInit(MonoIRecordInfo* pRecInfo, gpointer rec)
{
	return S_OK;
}

static int STDCALL
MonoIRecordInfoRecordClear(MonoIRecordInfo* pRecInfo, gpointer rec)
{
	return S_OK;
}

static int STDCALL
MonoIRecordInfoRecordCopy(MonoIRecordInfo* pRecInfo, gpointer rec, gpointer dest)
{
	memcpy (dest, rec, sizeof (int) * 3);
	return S_OK;
}

static int STDCALL
MonoIRecordInfoGetGuid(MonoIRecordInfo* pRecInfo, guint8* guid)
{
	static GUID test_guid = {0xdeadbeef, 0, 0, {0,0,0,0,0,0,0,7}};
	memcpy (guid, &test_guid, sizeof (test_guid));
	return S_OK;
}

static int STDCALL
MonoIRecordInfoGetName(MonoIRecordInfo* pRecInfo, gunichar2** name)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoGetSize(MonoIRecordInfo* pRecInfo, guint32* size)
{
	*size = sizeof (int) * 3;
	return S_OK;
}
...
static int STDCALL
MonoIRecordInfoGetTypeInfo(MonoIRecordInfo* pRecInfo, gpointer ppTypeInfo)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoGetField(MonoIRecordInfo* pRecInfo, gpointer data, gunichar2* name, VARIANT* var)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoGetFieldNoCopy(MonoIRecordInfo* pRecInfo, gpointer data, gunichar2* name, VARIANT* var, gpointer* ppvDataCArray)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoPutField(MonoIRecordInfo* pRecInfo, guint32 flags, gpointer data, gunichar2* name, VARIANT* var)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoPutFieldNoCopy(MonoIRecordInfo* pRecInfo, guint32 flags, gpointer data, gunichar2* name, VARIANT* var)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoGetFieldNames(MonoIRecordInfo* pRecInfo, guint32* num_names, gunichar2** names)
{
	return 0x80004001;
}

static int STDCALL
MonoIRecordInfoIsMatchingType(MonoIRecordInfo* pRecInfo, MonoIRecordInfo* pRecInfo2)
{
	return 1;
}

static gpointer STDCALL
MonoIRecordInfoRecordCreate(MonoIRecordInfo* pRecInfo)
{
	return marshal_alloc (sizeof (int) * 3);
}

static int STDCALL
MonoIRecordInfoRecordCreateCopy(MonoIRecordInfo* pRecInfo, gpointer source, gpointer* dest)
{
	*dest = marshal_alloc (sizeof (int) * 3);
	memcpy (*dest, source, sizeof (int) * 3);
	return S_OK;
}

static int STDCALL
MonoIRecordInfoRecordDestroy(MonoIRecordInfo* pRecInfo, gpointer rec)
{
	marshal_free (rec);
	return S_OK;
}

MonoIRecordInfoVTable MonoIRecordInfoTestVTable =
{
	MonoIRecordInfoQueryInterface,
	MonoIRecordInfoAddRef,
	MonoIRecordInfoRelease,
	MonoIRecordInfoRecordInit,
	MonoIRecordInfoRecordClear,
	MonoIRecordInfoRecordCopy,
	MonoIRecordInfoGetGuid,
	MonoIRecordInfoGetName,
	MonoIRecordInfoGetSize,
	MonoIRecordInfoGetTypeInfo,
	MonoIRecordInfoGetField,
	MonoIRecordInfoGetFieldNoCopy,
	MonoIRecordInfoPutField,
	MonoIRecordInfoPutFieldNoCopy,
	MonoIRecordInfoGetFieldNames,
	MonoIRecordInfoIsMatchingType,
	MonoIRecordInfoRecordCreate,
	MonoIRecordInfoRecordCreateCopy,
	MonoIRecordInfoRecordDestroy
};
...
LIBTEST_API int STDCALL
mono_test_cominterop_ccw_invoke (IDispatch *pDisp)
{
	static const gunichar2 test_exception[] = { 't','e','s','t',' ','e','x','c','e','p','t','i','o','n' };
	static const gunichar2 method[] = { 'm','e','t','h','o','d',0 };
	static const gunichar2 boolrefs[] = { 'b','o','o','l','r','e','f','s',0 };
	static const gunichar2 ifaceref[] = { 'i','f','a','c','e','r','e','f',0 };
	static const gunichar2 variantref[] = { 'v','a','r','i','a','n','t','r','e','f',0 };
	static const gunichar2 valuetype[] = { 'v','a','l','u','e','t','y','p','e',0 };
	static const gunichar2 valuetyperef[] = { 'v','a','l','u','e','t','y','p','e','r','e','f',0 };
	static const gunichar2 lpstrref[] = { 'l','p','s','t','r','r','e','f',0 };
	static const gunichar2 lparrayref[] = { 'l','p','a','r','r','a','y','r','e','f',0 };
	static const gunichar2 pressig[] = { 'p','r','e','s','s','i','g',0 };
	static const gunichar2 prop[] = { 'p','r','o','p',0 };
	static const gunichar2 propref[] = { 'p','r','o','p','r','e','f',0 };
	MonoIRecordInfo recinfo = { &MonoIRecordInfoTestVTable };
	struct {
		int x, y, z;
	} StructWith3Ints = { 7, 11, 12 };
	MonoComObject* com_obj, *com_obj2;
	gint32 intval, dispid, argid = 1;
	VARIANT args[3], res, var;
	...
	dp.rgvarg = args;
#ifdef WIN32
	dp.rgdispidNamedArgs = (DISPID*)&argid;
#else
	dp.rgdispidNamedArgs = &argid;
#endif
	dp.cArgs = 3;
	dp.cNamedArgs = 1;
	var.vt = VT_BSTR;
	var.bstrVal = marshal_bstr_alloc ("original");
	...
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, 0xdead, &dp, &res, NULL, NULL) != 0x80070057) {
		marshal_bstr_free (var.bstrVal);
		return 1;
	}
	if (res.vt != VT_EMPTY) {
		marshal_bstr_free (var.bstrVal);
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, NULL, NULL, NULL) != S_OK) {
		marshal_bstr_free (var.bstrVal);
		return 3;
	}
	if (!is_utf16_equals (var.bstrVal, "replaced")) {
		marshal_bstr_free (var.bstrVal);
		return 4;
	}
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUT, &dp, NULL, NULL, NULL) != 0x80020003) {
		marshal_bstr_free (var.bstrVal);
		return 5;
	}
	dp.cNamedArgs = 0;
	...
	args[1].byref = &var;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK) {
		marshal_bstr_free (var.bstrVal);
		return 6;
	}
	args[2].vt = VT_I4;
	args[2].lVal = 65536;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x8002000a) {
		marshal_bstr_free (var.bstrVal);
		return 7;
	}
	args[2].vt = VT_R8;
	...
	marshal_bstr_free (var.bstrVal);
	args[1].vt = VT_BSTR;
	args[1].bstrVal = marshal_bstr_alloc ("original");
	args[2].vt = VT_I2;
	args[2].iVal = -10;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK) {
		marshal_bstr_free (args[1].bstrVal);
		return 9;
	}
	if (!is_utf16_equals (args[1].bstrVal, "original")) {
		marshal_bstr_free (args[1].bstrVal);
		return 10;
	}
	var.bstrVal = args[1].bstrVal;
	args[1].vt = VT_BYREF | VT_VARIANT;
	args[1].byref = &var;
	...
	marshal_bstr_free (var.bstrVal);
	var.bstrVal = marshal_bstr_alloc ("throw");
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, &ei, NULL) != 0x80020009) {
		marshal_bstr_free (var.bstrVal);
		return 13;
	}
	marshal_bstr_free (var.bstrVal);
	if (ei.wCode != 0 || ei.pfnDeferredFillIn || ei.bstrHelpFile || ei.dwHelpContext ||
	    !is_utf16_equals (ei.bstrSource, "cominterop") ||
	    g_utf16_len (ei.bstrDescription) < (sizeof (test_exception) / 2) ||
	    memcmp (ei.bstrDescription, test_exception, sizeof (test_exception)))
		return 14;
	if (ei.scode != 0x80070057)
		return 15;
	args[1].vt = VT_I1;
	args[1].cVal = 10;
	args[2].vt = VT_RECORD;
	args[2].pvRecord = &StructWith3Ints;
	args[2].pRecInfo = (gpointer)&recinfo;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 16;
	args[2].vt = VT_PTR;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 17;
	...
	args[0].byref = &intval;
	args[1].vt = VT_BYREF | VT_UI4;
	args[1].byref = &uintval;
	args[2].vt = VT_BYREF | VT_VARIANT;
	args[2].byref = &var;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 20;
	if (intval != 0 || uintval == 0 || var.boolVal != VARIANT_FALSE)
		return 21;
	intval = 0;
	uintval = 3;
	var.vt = VT_BOOL;
	var.boolVal = VARIANT_FALSE;
	args[0].vt = VT_BYREF | VT_BOOL;
	args[1].vt = VT_BYREF | VT_BOOL;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 22;
	if ((gint16)intval != VARIANT_TRUE || (gint16)uintval != VARIANT_FALSE || var.boolVal != VARIANT_TRUE)
		return 23;
	...
	args[0].vt = VT_NULL;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 30;
	args[0].vt = VT_VOID;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 31;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, &ei, NULL) != 0x80020009)
		return 33;
	if (ei.scode != 0x80004003)
		return 34;
	create_com_object (&com_obj);
	args[0].punkVal = (gpointer)com_obj;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 35;
	if (res.vt != VT_I4 || res.lVal != -13)
		return 36;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 37;
	args[0].vt = VT_RECORD;
	args[0].pRecInfo = (gpointer)&recinfo;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 38;
	args[0].vt = VT_ARRAY | VT_BOOL;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 39;
	args[0].vt = VT_SAFEARRAY;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 40;
	args[0].vt = VT_BYREF | VT_UNKNOWN;
	args[0].byref = &com_obj;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 41;
	if (res.vt != VT_I4 || res.lVal != -13)
		return 42;
	memset (&res, 0, sizeof (res));
	if (!com_obj || com_obj->vtbl->QueryInterface (com_obj, &IID_ITest, (gpointer*)&com_obj2) != 0x80004002)
		return 43;
	if (com_obj->vtbl->QueryInterface (com_obj, &IID_IMonoUnknown, (gpointer*)&com_obj2) != S_OK)
		return 44;
	com_obj->vtbl->Release (com_obj2);
	com_obj->vtbl->Release (com_obj);

	name = variantref;
	args[0].vt = VT_EMPTY;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, &ei, NULL) != 0x80020009)
		return 50;
	if (ei.scode != 0x80004003)
		return 51;
	args[0].vt = VT_R4;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 54;
	if (args[0].vt != VT_I4 || args[0].lVal != 42)
		return 55;
	args[0].vt = VT_BYREF | VT_I4;
	args[0].byref = &intval;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 56;
	if (args[0].vt != (VT_BYREF | VT_I4) || intval != 1)
		return 57;
	var.vt = VT_I4;
	var.lVal = 42;
	args[0].vt = VT_BYREF | VT_VARIANT;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 58;
	if (var.vt != VT_R4 || var.fltVal != 1.0f)
		return 59;
	var.vt = VT_BSTR;
	var.bstrVal = marshal_bstr_alloc ("test string");
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 60;
	if (var.vt != VT_UI2 || var.uiVal != 50)
		return 61;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 71;
	args[0].vt = VT_RECORD;
	args[0].pvRecord = &StructWith3Ints;
	args[0].pRecInfo = NULL;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 72;
	args[0].pRecInfo = (gpointer)&recinfo;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 73;
	if (res.vt != VT_BOOL || res.boolVal != VARIANT_TRUE)
		return 74;
	memset (&res, 0, sizeof (res));
	if (StructWith3Ints.x != 7 || StructWith3Ints.y != 11 || StructWith3Ints.z != 12)
		return 75;
	args[0].vt = VT_USERDEFINED;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 76;
	args[0].vt = VT_PTR;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 77;
	args[0].vt = VT_ARRAY | VT_I4;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 78;
	args[0].vt = VT_SAFEARRAY;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
	...
	if (StructWith3Ints.x != 7 || StructWith3Ints.y != 11 || StructWith3Ints.z != 12)
		return 83;
	args[0].vt = VT_BYREF | VT_RECORD;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 84;
	if (StructWith3Ints.x != 10 || StructWith3Ints.y != 1 || StructWith3Ints.z != 24)
		return 85;
	args[0].vt = VT_BYREF | VT_USERDEFINED;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 86;
	args[0].vt = VT_BYREF | VT_PTR;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 87;
	args[0].vt = VT_BYREF | VT_ARRAY | VT_I4;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 88;
	args[0].vt = VT_BYREF | VT_SAFEARRAY;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != 0x80070057)
		return 89;
	...
	args[0].byref = &var;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 90;
	if (!is_utf16_equals (var.bstrVal, "test."))
		return 91;
	if (res.vt != VT_BSTR || !is_utf16_equals (res.bstrVal, "> test."))
		return 92;
	marshal_bstr_free (var.bstrVal);
	marshal_bstr_free (res.bstrVal);
	memset (&res, 0, sizeof (res));

	(void) lparrayref;
#ifdef WIN32
{
	gunichar2* str1 = marshal_bstr_alloc ("foo");
	gunichar2* str2 = marshal_bstr_alloc ("bar");
	LONG idx0 = 0, idx1 = 1;
	SAFEARRAYBOUND bnd[1];
	SAFEARRAY* sa;
	bnd[0].lLbound = 0;
	bnd[0].cElements = 2;
	sa = SafeArrayCreate (VT_BSTR, 1, bnd);
	SafeArrayPutElement (sa, &idx0, str1);
	SafeArrayPutElement (sa, &idx1, str2);
	marshal_bstr_free (str1);
	marshal_bstr_free (str2);
	...
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 100;
	SafeArrayGetElement (sa, &idx0, &str1);
	SafeArrayGetElement (sa, &idx1, &str2);
	if (sa != args[0].byref || !is_utf16_equals (str1, "foo") || !is_utf16_equals (str2, "bar"))
		return 101;
	marshal_bstr_free (str1);
	marshal_bstr_free (str2);
	if (res.vt != (VT_ARRAY | VT_BSTR))
		return 102;
	SafeArrayGetElement (res.byref, &idx0, &str1);
	SafeArrayGetElement (res.byref, &idx1, &str2);
	if (!is_utf16_equals (str1, "ret") || !is_utf16_equals (str2, "val"))
		return 103;
	marshal_bstr_free (str1);
	marshal_bstr_free (str2);
	VariantClear (&res);
	memset (&res, 0, sizeof (res));
	args[0].vt = VT_BYREF | VT_ARRAY | VT_BSTR;
	args[0].byref = &sa;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, NULL, NULL) != S_OK)
		return 104;
	sa = *(SAFEARRAY**)args[0].byref;
	SafeArrayGetElement (sa, &idx0, &str1);
	SafeArrayGetElement (sa, &idx1, &str2);
	if (!is_utf16_equals (str1, "@foo") || !is_utf16_equals (str2, "#bar"))
		return 105;
	marshal_bstr_free (str1);
	marshal_bstr_free (str2);
	SafeArrayDestroy (sa);
	...
	name = pressig;
	dp.cArgs = 2;
	args[0].vt = VT_BYREF | VT_UI4;
	args[0].byref = &uintval;
	args[1].vt = VT_I2;
	args[1].iVal = 0;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 110;
	if (uintval != 99 || res.vt != VT_I4 || res.lVal != -1010)
		return 111;
	memset (&res, 0, sizeof (res));
	args[1].iVal = 1010;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, NULL, &ei, NULL) != 0x80020009)
	...
	name = prop;
	argid = -3;  // DISPID_PROPERTYPUT
	dp.cArgs = dp.cNamedArgs = 1;
	args[0].vt = VT_I4;
	args[0].lVal = 10;
	if (pDisp->lpVtbl->GetIDsOfNames (pDisp, &IID_IMonoNULL, (void*)&name, 1, 0x00000800, (void*)&dispid) != S_OK ||
	    pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUT, &dp, NULL, NULL, NULL) != S_OK)
		return 120;
	dp.cNamedArgs = 0;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != 0x8002000e)
		return 121;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != 0x8002000e)
		return 122;
	dp.cArgs = 0;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD, &dp, &res, NULL, NULL) != S_OK)
		return 123;
	if (res.vt != VT_UI1 || res.bVal != 10)
		return 124;
	memset (&res, 0, sizeof (res));
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != S_OK)
		return 125;
	if (res.vt != VT_UI1 || res.bVal != 10)
		return 126;
	memset (&res, 0, sizeof (res));
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_METHOD | DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != S_OK)
		return 127;
	if (res.vt != VT_UI1 || res.bVal != 10)
		return 128;
	memset (&res, 0, sizeof (res));
	...
	args[0].vt = VT_I2;
	args[0].iVal = 7;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUTREF, &dp, NULL, NULL, NULL) != S_OK)
		return 129;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != 0x8002000e)
		return 130;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != S_OK)
		return 131;
	if (res.vt != VT_UI1 || res.bVal != 7)
		return 132;
	memset (&res, 0, sizeof (res));
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUT, &dp, NULL, NULL, NULL) != 0x8002000e)
		return 133;
	dp.cArgs = 1;
	...
	args[0].byref = &intval;
	intval = 42;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUT, &dp, NULL, NULL, NULL) != S_OK)
		return 134;
	dp.cArgs = 0;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != S_OK)
		return 135;
	if (res.vt != VT_UI1 || res.bVal != 42)
		return 136;
	memset (&res, 0, sizeof (res));
	dp.cArgs = 1;
	intval = 13;
	...
	dp.cArgs = 1;
	intval = 500;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUTREF, &dp, NULL, NULL, NULL) != 0x8002000a)
		return 143;
	...
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUT, &dp, NULL, NULL, NULL) != 0x80020003)
		return 151;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYPUTREF, &dp, NULL, NULL, NULL) != 0x80020003)
		return 152;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != 0x8002000e)
		return 153;
	dp.cArgs = 0;
	if (pDisp->lpVtbl->Invoke (pDisp, dispid, &IID_IMonoNULL, 0x00000800, DISPATCH_PROPERTYGET, &dp, &res, NULL, NULL) != 0x8013151a)  // COR_E_MEMBERACCESS
		return 154;
