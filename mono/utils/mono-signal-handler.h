 ...
 *
 * One way to fix it is using NOPs to neutralize the skips, like we do
 * below.  TJ from Mobisocial suggested another way to fix it, namely
 * to compile the signal handler to THUMB code, for which the bug
 * should not happen.
 */
