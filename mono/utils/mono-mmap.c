...
{
	mono_counters_register ("Malloc memory", MONO_COUNTER_WORD | MONO_COUNTER_RUNTIME | MONO_COUNTER_BYTES | MONO_COUNTER_VARIABLE, (void*)&mono_stat_malloc_memory);
	mono_counters_register ("Malloc traffic", MONO_COUNTER_WORD | MONO_COUNTER_RUNTIME | MONO_COUNTER_BYTES | MONO_COUNTER_VARIABLE, (void*)&mono_stat_malloc_traffic);
