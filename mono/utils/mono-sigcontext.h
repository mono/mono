...
#include <ucontext.h>
	...
	#define UCONTEXT_REG_Rn(ctx, n)   ((ctx)->uc_mcontext.jmp_context.gpr[(n)])
	#define UCONTEXT_REG_FPRn(ctx, n) ((ctx)->uc_mcontext.jmp_context.fpr[(n)])
	#define UCONTEXT_REG_NIP(ctx)     ((ctx)->uc_mcontext.jmp_context.iar)
	#define UCONTEXT_REG_LNK(ctx)     ((ctx)->uc_mcontext.jmp_context.lr)
#endif
