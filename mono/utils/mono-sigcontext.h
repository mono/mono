...
#  endif
	...
	// The XMM registers are stored as an array of 16 chars, for 128 bits total. We want to use the
	// low 64 bits only, so we can cast the start of each register to an unsigned 64-bit integer.
	#define UCONTEXT_REG_FPR0_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm0)
	#define UCONTEXT_REG_FPR1_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm1)
	#define UCONTEXT_REG_FPR2_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm2)
	#define UCONTEXT_REG_FPR3_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm3)
	#define UCONTEXT_REG_FPR4_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm4)
	#define UCONTEXT_REG_FPR5_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm5)
	#define UCONTEXT_REG_FPR6_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm6)
	#define UCONTEXT_REG_FPR7_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm7)
	#define UCONTEXT_REG_FPR8_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm8)
	#define UCONTEXT_REG_FPR9_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm9)
	#define UCONTEXT_REG_FPR10_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm10)
	#define UCONTEXT_REG_FPR11_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm11)
	#define UCONTEXT_REG_FPR12_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm12)
	#define UCONTEXT_REG_FPR13_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm13)
	#define UCONTEXT_REG_FPR14_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm14)
	#define UCONTEXT_REG_FPR15_LOW(ctx) *(guint64*)&(((ucontext_t*)(ctx))->uc_mcontext->__fs.__fpu_xmm15)
