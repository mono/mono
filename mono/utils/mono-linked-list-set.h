...
#define MONO_LLS_FOREACH_FILTERED(list, type, elem, filter, /*stmt*/...) \
	do { \
...
#define MONO_LLS_FOREACH(list, type, elem, /*stmt*/...) \
	MONO_LLS_FOREACH_FILTERED ((list), type, elem, mono_lls_filter_accept_all, __VA_ARGS__)
...
#define MONO_LLS_FOREACH_FILTERED_SAFE(list, type, elem, filter, /*stmt*/...) \
	do { \
...
#define MONO_LLS_FOREACH_SAFE(list, type, elem, /*stmt*/...) \
	MONO_LLS_FOREACH_FILTERED_SAFE ((list), type, elem, mono_lls_filter_accept_all, __VA_ARGS__)
