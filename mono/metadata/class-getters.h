...
MONO_CLASS_GETTER(m_class_get_inited, guint, , MonoClass, inited)
MONO_CLASS_GETTER(m_class_get_size_inited, guint, , MonoClass, size_inited)
MONO_CLASS_GETTER(m_class_get_valuetype, guint, , MonoClass, valuetype)
MONO_CLASS_GETTER(m_class_get_enumtype, guint, , MonoClass, enumtype)
MONO_CLASS_GETTER(m_class_get_blittable, guint, , MonoClass, blittable)
MONO_CLASS_GETTER(m_class_get_unicode, guint, , MonoClass, unicode)
MONO_CLASS_GETTER(m_class_get_wastypebuilder, guint, , MonoClass, wastypebuilder)
MONO_CLASS_GETTER(m_class_get_is_array_special_interface, guint, , MonoClass, is_array_special_interface)
...
MONO_CLASS_GETTER(m_class_get_ghcimpl, guint, , MonoClass, ghcimpl)
MONO_CLASS_GETTER(m_class_get_has_finalize, guint, , MonoClass, has_finalize)
...
#endif
MONO_CLASS_GETTER(m_class_get_delegate, guint, , MonoClass, delegate)
MONO_CLASS_GETTER(m_class_get_gc_descr_inited, guint, , MonoClass, gc_descr_inited)
MONO_CLASS_GETTER(m_class_get_has_cctor, guint,  , MonoClass, has_cctor)
MONO_CLASS_GETTER(m_class_get_has_references, guint, , MonoClass, has_references)
MONO_CLASS_GETTER(m_class_get_has_static_refs, guint, , MonoClass, has_static_refs)
MONO_CLASS_GETTER(m_class_get_no_special_static_fields, guint, , MonoClass, no_special_static_fields)
MONO_CLASS_GETTER(m_class_get_is_com_object, guint, , MonoClass, is_com_object)
MONO_CLASS_GETTER(m_class_get_nested_classes_inited, guint, , MonoClass, nested_classes_inited)
MONO_CLASS_GETTER(m_class_get_class_kind, guint, , MonoClass, class_kind)
MONO_CLASS_GETTER(m_class_get_interfaces_inited, guint, , MonoClass, interfaces_inited)
MONO_CLASS_GETTER(m_class_get_simd_type, guint, , MonoClass, simd_type)
MONO_CLASS_GETTER(m_class_get_has_finalize_inited, guint, , MonoClass, has_finalize_inited)
MONO_CLASS_GETTER(m_class_get_fields_inited, guint, , MonoClass, fields_inited)
MONO_CLASS_GETTER(m_class_get_has_failure, guint, , MonoClass, has_failure)
MONO_CLASS_GETTER(m_class_get_has_weak_fields, guint, , MonoClass, has_weak_fields)
