...
MonoType*
mono_reflection_get_type_checked (MonoImage *rootimage, MonoImage* image, MonoTypeNameParse *info, mono_bool ignorecase, gboolean search_mscorlib, mono_bool *type_resolve, MonoError *error);
