...
MonoImage*
mono_image_open_from_module_handle_with_alc (MonoAssemblyLoadContext *alc, HMODULE module_handle, char* fname, gboolean has_entry_point, MonoImageOpenStatus* status)
{
	MonoImage* image;
	MonoCLIImageInfo* iinfo;
...
mono_image_open_from_module_handle (HMODULE module_handle, char* fname, gboolean has_entry_point, MonoImageOpenStatus* status)
{
	...
	return mono_image_open_from_module_handle_with_alc (alc, module_handle, fname, has_entry_point, status);
}
#endif
...
mono_image_open_a_lot_parameterized (MonoLoadedImages *li, MonoAssemblyLoadContext *alc, const char *fname, MonoImageOpenStatus *status, gboolean refonly, gboolean load_from_context, gboolean *problematic)
{
	...
	if (!refonly) {
		...
		return mono_image_open_from_module_handle_with_alc (alc, module_handle, absfname, FALSE, status);
	}
#endif
