...
MONO_PROFILER_EVENT_3(gc_handle_created, GCHandleCreated, MonoGCHandle, handle, MonoGCHandleType, type, MonoObject *, object)
MONO_PROFILER_EVENT_2(gc_handle_deleted, GCHandleDeleted, MonoGCHandle, handle, MonoGCHandleType, type)
