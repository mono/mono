...
typedef struct {
	const char *name;
	// FIXMEjiticall change to non-const gpointer
	gconstpointer func;
	...
	MonoMethod *interp_lmf_wrapper; // FIXMEjiticall maybe store this externally
	gboolean inited;		// FIXMEjiticall probably redundant with func or name
} MonoJitICallInfo;
