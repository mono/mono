...
int ves_icall_System_Threading_Thread_GetPriority (MonoInternalThread *this_obj);
void ves_icall_System_Threading_Thread_SetPriority (MonoInternalThread *this_obj, int priority);
