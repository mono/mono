...
void ves_icall_System_Threading_Thread_ClrState (MonoInternalThreadHandle thread, MonoThreadState state, MonoError *error);
void ves_icall_System_Threading_Thread_SetState (MonoInternalThreadHandle thread_handle, MonoThreadState state, MonoError *error);
MonoThreadState ves_icall_System_Threading_Thread_GetState (MonoInternalThreadHandle thread_handle, MonoError *error);
