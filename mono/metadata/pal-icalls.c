...
mono_pal_init (void)
{
	...
	if (mono_atomic_cas_i32 (&module_initialized, TRUE, FALSE) == FALSE) {
		mono_add_internal_call ("Interop/Sys::Read", (gpointer)&ves_icall_Interop_Sys_Read);

#if defined(__APPLE__)
		mono_add_internal_call ("Interop/RunLoop::CFRunLoopRun", (gpointer)&ves_icall_Interop_RunLoop_CFRunLoopRun);
#endif
	}
