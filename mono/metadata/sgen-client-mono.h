...
{
#ifdef ENABLE_DTRACE
	const char *name_space = sgen_client_vtable_get_namespace (g_cast (vtable));
	const char *name = sgen_client_vtable_get_name (g_cast (vtable));
...
{
	MONO_GC_MAJOR_OBJ_ALLOC_DEGRADED ((mword)obj, size, sgen_client_vtable_get_namespace (g_cast (vtable)), sgen_client_vtable_get_name (g_cast (vtable)));
}
...
sgen_client_binary_protocol_pin (gpointer obj, gpointer vtable, size_t size)
{
	...
	if (G_UNLIKELY (MONO_GC_OBJ_PINNED_ENABLED ())) {
		...
		MONO_GC_OBJ_PINNED ((mword)obj,
				sgen_safe_object_get_size ( g_cast(obj)),
				sgen_client_vtable_get_namespace (g_cast (vtable)), sgen_client_vtable_get_name (g_cast (vtable)), gen);
	}
#endif
}
...
sgen_client_binary_protocol_cement (gpointer ptr, gpointer vtable, size_t size)
{
	...
	if (G_UNLIKELY (MONO_GC_OBJ_CEMENTED_ENABLED())) {
		MONO_GC_OBJ_CEMENTED ((mword)ptr, sgen_safe_object_get_size ((GCObject*)ptr),
				sgen_client_vtable_get_namespace (g_cast (vtable)), sgen_client_vtable_get_name (g_cast (vtable)));
	}
#endif
}
...
sgen_client_binary_protocol_copy (gpointer from, gpointer to, gpointer vtable, size_t size)
{
	...
	if (G_UNLIKELY (MONO_GC_OBJ_MOVED_ENABLED ())) {
		...
		MONO_GC_OBJ_MOVED ((mword)to, (mword)from, dest_gen, src_gen, size, sgen_client_vtable_get_namespace (g_cast (vtable)), sgen_client_vtable_get_name (g_cast (vtable)));
	}
#endif
}
...
sgen_client_binary_protocol_global_remset (gpointer ptr, gpointer value, gpointer value_vtable)
{
	...
	if (G_UNLIKELY (MONO_GC_GLOBAL_REMSET_ADD_ENABLED ())) {
		MONO_GC_GLOBAL_REMSET_ADD ((mword)ptr, (mword)value, sgen_safe_object_get_size ((GCObject*)value),
				sgen_client_vtable_get_namespace (g_cast (value_vtable)), sgen_client_vtable_get_name (g_cast (value_vtable)));
	}
#endif
}
...
sgen_client_binary_protocol_dislink_update (gpointer link, gpointer obj, gboolean track)
{
	...
	if (MONO_GC_WEAK_UPDATE_ENABLED ()) {
		...
		MONO_GC_WEAK_UPDATE ((mword)link,
				(mword)obj,
				obj ? sgen_safe_object_get_size (g_cast (obj)) : 0u,
