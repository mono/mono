...
mono_class_get_ref_info (MonoClass *klass)
{
	...
	gpointer ref_info_handle = mono_class_get_ref_info_handle (klass);
...
mono_class_set_ref_info (MonoClass *klass, MonoObjectHandle obj)
{
	...
	gpointer candidate = mono_gchandle_from_handle (obj, FALSE);
	gpointer handle = mono_class_set_ref_info_handle (klass, candidate);
...
mono_class_free_ref_info (MonoClass *klass)
{
	...
	gpointer handle = mono_class_get_ref_info_handle (klass);
