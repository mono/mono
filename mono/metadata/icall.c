...
static char mono_create_icall_signatures_ptrref;

#define ICALL_SIG_TYPE_int 	(MonoType*)&mono_defaults.int_class
#define ICALL_SIG_TYPE_ptr 	(MonoType*)&mono_defaults.int_class // ?
#define ICALL_SIG_TYPE_ptrref 	(MonoType*)&mono_create_icall_signatures_ptrref
#define ICALL_SIG_TYPE_void 	(MonoType*)&mono_defaults.void_class
#define ICALL_SIG_TYPE_int32 	(MonoType*)&mono_defaults.int32_class
#define ICALL_SIG_TYPE_uint32 	(MonoType*)&mono_defaults.uint32_class
#define ICALL_SIG_TYPE_int8 	(MonoType*)&mono_defaults.sbyte_class
#define ICALL_SIG_TYPE_uint8 	(MonoType*)&mono_defaults.byte_class
#define ICALL_SIG_TYPE_int16 	(MonoType*)&mono_defaults.int16_class
#define ICALL_SIG_TYPE_uint16 	(MonoType*)&mono_defaults.uint16_class
#define ICALL_SIG_TYPE_long 	(MonoType*)&mono_defaults.int64_class
#define ICALL_SIG_TYPE_ulong 	(MonoType*)&mono_defaults.uint64_class
#define ICALL_SIG_TYPE_float 	(MonoType*)&mono_defaults.single_class
#define ICALL_SIG_TYPE_double 	(MonoType*)&mono_defaults.double_class
#define ICALL_SIG_TYPE_object 	(MonoType*)&mono_defaults.object_class
#define ICALL_SIG_TYPE_obj 	(MonoType*)&mono_defaults.object_class
#define ICALL_SIG_TYPE_string 	(MonoType*)&mono_defaults.string_class
#define ICALL_SIG_TYPE_bool 	(MonoType*)&mono_defaults.boolean_class
#define ICALL_SIG_TYPE_boolean 	(MonoType*)&mono_defaults.boolean_class

// The initializer has a different type than the result and
...
mono_create_icall_signatures (void)
{
	...
	while ((n = sig->param_count)) {
		--sig->param_count; // remove ret (leave terminal element unchanged)
		MonoClass ***types = (MonoClass***)(sig + 1);
		for (int i = 0; i < n; ++i) {
			MonoClass** klass = types [i];
			*(i ? &sig->params [i - 1] : &sig->ret) =
				(klass == (gpointer)&mono_create_icall_signatures_ptrref)
				? (++ptrref_hits, ptrref) : m_class_get_byval_arg (*klass);
		}
		sig = (MonoMethodSignature*)(types + n);
	}
	g_assert (ptrref_hits);
}
