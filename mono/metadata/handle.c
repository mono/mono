...
gpointer
mono_array_handle_pin_with_size (MonoArrayHandle handle, int size, uintptr_t idx, gpointer *gchandle)
{
...
gunichar2*
mono_string_handle_pin_chars (MonoStringHandle handle, gpointer *gchandle)
{
	g_assert (gchandle != NULL);
	*gchandle = mono_gchandle_from_handle (MONO_HANDLE_CAST (MonoObject, handle), TRUE);
...
gpointer
mono_object_handle_pin_unbox (MonoObjectHandle obj, gpointer *gchandle)
{
