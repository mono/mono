...
HANDLES(ICALL(BUFFER_1, "InternalBlockCopy", ves_icall_System_Buffer_BlockCopyInternal))
HANDLES(ICALL(BUFFER_2, "_ByteLength", ves_icall_System_Buffer_ByteLengthInternal))
HANDLES(ICALL(BUFFER_3, "_GetByte", ves_icall_System_Buffer_GetByteInternal))
HANDLES(ICALL(BUFFER_4, "_SetByte", ves_icall_System_Buffer_SetByteInternal))
