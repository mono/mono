...
NOHANDLES(ICALL(MONIT_8, "Enter_icall", ves_icall_System_Threading_Monitor_Monitor_Enter))
NOHANDLES(ICALL(MONIT_1, "Exit_icall", mono_monitor_exit_icall))
NOHANDLES(ICALL(MONIT_2, "Monitor_pulse", ves_icall_System_Threading_Monitor_Monitor_pulse))
NOHANDLES(ICALL(MONIT_3, "Monitor_pulse_all", ves_icall_System_Threading_Monitor_Monitor_pulse_all))
NOHANDLES(ICALL(MONIT_4, "Monitor_test_owner", ves_icall_System_Threading_Monitor_Monitor_test_owner))
NOHANDLES(ICALL(MONIT_5, "Monitor_test_synchronised", ves_icall_System_Threading_Monitor_Monitor_test_synchronised))
NOHANDLES(ICALL(MONIT_7, "Monitor_wait", ves_icall_System_Threading_Monitor_Monitor_wait))
NOHANDLES(ICALL(MONIT_9, "try_enter_with_atomic_var", ves_icall_System_Threading_Monitor_Monitor_try_enter_with_atomic_var))
