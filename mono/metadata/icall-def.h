...
NOHANDLES(ICALL(GC_0, "GetAllocatedBytesForCurrentThread", ves_icall_System_GC_GetAllocatedBytesForCurrentThread))
NOHANDLES(ICALL(GC_0a, "GetCollectionCount", ves_icall_System_GC_GetCollectionCount))
HANDLES(GC_0b, "GetGeneration", ves_icall_System_GC_GetGeneration, int, 1, (MonoObject))
NOHANDLES(ICALL(GC_0c, "GetMaxGeneration", ves_icall_System_GC_GetMaxGeneration))
