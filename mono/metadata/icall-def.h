...
NOHANDLES(ICALL(ILOCK_9, "CompareExchange(single&,single,single)", ves_icall_System_Threading_Interlocked_CompareExchange_Single))
NOHANDLES(ICALL(ILOCK_10, "CompareExchange_object", ves_icall_System_Threading_Interlocked_CompareExchange_Object))
...
NOHANDLES(ICALL(ILOCK_18, "Exchange(single&,single)", ves_icall_System_Threading_Interlocked_Exchange_Single))
NOHANDLES(ICALL(ILOCK_19, "Exchange_object", ves_icall_System_Threading_Interlocked_Exchange_Object))
