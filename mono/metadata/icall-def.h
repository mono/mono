...
NOHANDLES(ICALL(MONIT_0, "Enter_icall", mono_monitor_enter_internal))
...
NOHANDLES(ICALL(MONIT_9, "try_enter_with_atomic_var", mono_monitor_try_enter_with_atomic_var))
