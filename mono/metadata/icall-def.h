...
ICALL(GC_4, "RecordPressure", mono_gc_add_memory_pressure)
ICALL(GC_5, "WaitForPendingFinalizers", ves_icall_System_GC_WaitForPendingFinalizers)
ICALL(GC_6, "_ReRegisterForFinalize", ves_icall_System_GC_ReRegisterForFinalize)
