...
NOHANDLES(ICALL(RUNTIME_15, "DumpStateSingle_icall", ves_icall_Mono_Runtime_DumpStateSingle))
NOHANDLES(ICALL(RUNTIME_16, "DumpStateTotal_icall", ves_icall_Mono_Runtime_DumpStateTotal))
NOHANDLES(ICALL(RUNTIME_18, "EnableCrashReportLog_internal", ves_icall_Mono_Runtime_EnableCrashReportingLog))
NOHANDLES(ICALL(RUNTIME_2, "EnableMicrosoftTelemetry_internal", ves_icall_Mono_Runtime_EnableMicrosoftTelemetry))
NOHANDLES(ICALL(RUNTIME_3, "ExceptionToState_icall", ves_icall_Mono_Runtime_ExceptionToState))
NOHANDLES(ICALL(RUNTIME_4, "GetDisplayName_icall", ves_icall_Mono_Runtime_GetDisplayName_icall))
NOHANDLES(ICALL(RUNTIME_12, "GetNativeStackTrace_icall", ves_icall_Mono_Runtime_GetNativeStackTrace_icall))
...
NOHANDLES(ICALL(RUNTIME_13, "SendMicrosoftTelemetry_internal", ves_icall_Mono_Runtime_SendMicrosoftTelemetry))
NOHANDLES(ICALL(RUNTIME_14, "WriteStateToFile_internal", ves_icall_Mono_Runtime_DumpTelemetry))
