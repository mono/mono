...
ICALL(BTLS_ERROR_3, "mono_btls_error_get_error_line", mono_btls_error_get_error_line)
ICALL(BTLS_ERROR_4, "mono_btls_error_get_error_string_n", mono_btls_error_get_error_string_n)
ICALL(BTLS_ERROR_5, "mono_btls_error_peek_error", mono_btls_error_peek_error)
ICALL(BTLS_ERROR_6, "mono_btls_error_peek_error_line", mono_btls_error_peek_error_line)
