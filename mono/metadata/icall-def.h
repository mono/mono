...
HANDLES(NDNS_1, "GetHostByAddr_icall", ves_icall_System_Net_Dns_GetHostByAddr_icall, MonoBoolean, 5, (MonoString, MonoStringOut, MonoArrayOut, MonoArrayOut, gint32))
HANDLES(NDNS_2, "GetHostByName_icall", ves_icall_System_Net_Dns_GetHostByName_icall, MonoBoolean, 5, (MonoString, MonoStringOut, MonoArrayOut, MonoArrayOut, gint32))
HANDLES(NDNS_3, "GetHostName_icall", ves_icall_System_Net_Dns_GetHostName_icall, MonoBoolean, 1, (MonoStringOut))
#endif
...
HANDLES(MAC_IFACE_PROPS_1, "ParseRouteInfo_icall", ves_icall_System_Net_NetworkInformation_MacOsIPInterfaceProperties_ParseRouteInfo_icall, MonoBoolean, 2, (MonoString, MonoArrayOut))
...
NOHANDLES(ICALL(SOCK_3, "Bind_icall", ves_icall_System_Net_Sockets_Socket_Bind_icall))
...
NOHANDLES(ICALL(SOCK_6, "Connect_icall", ves_icall_System_Net_Sockets_Socket_Connect_icall))
...
NOHANDLES(ICALL(SOCK_10, "LocalEndPoint_icall", ves_icall_System_Net_Sockets_Socket_LocalEndPoint_icall))
NOHANDLES(ICALL(SOCK_11, "Poll_icall", ves_icall_System_Net_Sockets_Socket_Poll_icall))
NOHANDLES(ICALL(SOCK_13, "ReceiveFrom_icall", ves_icall_System_Net_Sockets_Socket_ReceiveFrom_icall))
...
NOHANDLES(ICALL(SOCK_14, "RemoteEndPoint_icall", ves_icall_System_Net_Sockets_Socket_RemoteEndPoint_icall))
...
NOHANDLES(ICALL(SOCK_16, "SendTo_icall", ves_icall_System_Net_Sockets_Socket_SendTo_icall))
...
NOHANDLES(ICALL(SOCK_20, "Socket_icall", ves_icall_System_Net_Sockets_Socket_Socket_icall))
NOHANDLES(ICALL(SOCK_20a, "SupportsPortReuse", ves_icall_System_Net_Sockets_Socket_SupportPortReuse_icall))
NOHANDLES(ICALL(SOCK_21a, "cancel_blocking_socket_operation", ves_icall_cancel_blocking_socket_operation))
