...
NOHANDLES(ICALL(MATH_1, "Abs(double)", ves_icall_System_Math_Abs_double))
NOHANDLES(ICALL(MATH_2, "Abs(single)", ves_icall_System_Math_Abs_single))
NOHANDLES(ICALL(MATH_3, "Acos", ves_icall_System_Math_Acos))
NOHANDLES(ICALL(MATH_4, "Acosh", ves_icall_System_Math_Acosh))
NOHANDLES(ICALL(MATH_5, "Asin", ves_icall_System_Math_Asin))
NOHANDLES(ICALL(MATH_6, "Asinh", ves_icall_System_Math_Asinh))
NOHANDLES(ICALL(MATH_7, "Atan", ves_icall_System_Math_Atan))
NOHANDLES(ICALL(MATH_8, "Atan2", ves_icall_System_Math_Atan2))
NOHANDLES(ICALL(MATH_9, "Atanh", ves_icall_System_Math_Atanh))
NOHANDLES(ICALL(MATH_10, "Cbrt", ves_icall_System_Math_Cbrt))
NOHANDLES(ICALL(MATH_11, "Ceiling", ves_icall_System_Math_Ceiling))
NOHANDLES(ICALL(MATH_12, "Cos", ves_icall_System_Math_Cos))
NOHANDLES(ICALL(MATH_13, "Cosh", ves_icall_System_Math_Cosh))
NOHANDLES(ICALL(MATH_14, "Exp", ves_icall_System_Math_Exp))
NOHANDLES(ICALL(MATH_15, "FMod", ves_icall_System_Math_FMod))
NOHANDLES(ICALL(MATH_16, "Floor", ves_icall_System_Math_Floor))
NOHANDLES(ICALL(MATH_17, "Log", ves_icall_System_Math_Log))
NOHANDLES(ICALL(MATH_18, "Log10", ves_icall_System_Math_Log10))
NOHANDLES(ICALL(MATH_19, "ModF", ves_icall_System_Math_ModF))
NOHANDLES(ICALL(MATH_20, "Pow", ves_icall_System_Math_Pow))
NOHANDLES(ICALL(MATH_21, "Sin", ves_icall_System_Math_Sin))
NOHANDLES(ICALL(MATH_22, "Sinh", ves_icall_System_Math_Sinh))
NOHANDLES(ICALL(MATH_23, "Sqrt", ves_icall_System_Math_Sqrt))
NOHANDLES(ICALL(MATH_24, "Tan", ves_icall_System_Math_Tan))
NOHANDLES(ICALL(MATH_25, "Tanh", ves_icall_System_Math_Tanh))
