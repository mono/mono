...
NOHANDLES(ICALL(ILOCK_10b, "CompareExchange_T", ves_icall_System_Threading_Interlocked_CompareExchange_Object))
NOHANDLES(ICALL(ILOCK_10c, "CompareExchange_object", ves_icall_System_Threading_Interlocked_CompareExchange_Object))
...
NOHANDLES(ICALL(ILOCK_19c, "Exchange_object", ves_icall_System_Threading_Interlocked_Exchange_Object))
