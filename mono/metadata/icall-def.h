...
HANDLES(RUNTIME_2, "EnableMicrosoftTelemetry_internal", ves_icall_Mono_Runtime_EnableMicrosoftTelemetry, void, 7, (char_ptr, char_ptr, char_ptr, char_ptr, char_ptr, char_ptr, char_ptr))
