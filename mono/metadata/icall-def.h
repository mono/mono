...
HANDLES(ICALL(DECIMAL_1, ".ctor(double)", mono_decimal_init_double))
HANDLES(ICALL(DECIMAL_2, ".ctor(single)", mono_decimal_init_single))
HANDLES(ICALL(DECIMAL_3, "FCallAddSub(System.Decimal&,System.Decimal&,byte)", mono_decimal_addsub))
HANDLES(ICALL(DECIMAL_4, "FCallCompare", mono_decimal_compare))
HANDLES(ICALL(DECIMAL_5, "FCallDivide", mono_decimal_divide))
HANDLES(ICALL(DECIMAL_6, "FCallFloor", mono_decimal_floor))
HANDLES(ICALL(DECIMAL_7, "FCallMultiply", mono_decimal_multiply))
HANDLES(ICALL(DECIMAL_8, "FCallRound", mono_decimal_round))
HANDLES(ICALL(DECIMAL_9, "FCallToInt32", mono_decimal_to_int32))
HANDLES(ICALL(DECIMAL_10, "FCallTruncate", mono_decimal_truncate))
HANDLES(ICALL(DECIMAL_11, "GetHashCode", mono_decimal_get_hash_code))
HANDLES(ICALL(DECIMAL_12, "ToDouble", mono_decimal_to_double))
HANDLES(ICALL(DECIMAL_13, "ToSingle", mono_decimal_to_float))
#endif
