...
NOHANDLES(ICALL(ILOCK_3, "CompareExchange(T&,T&,T&,T&)", ves_icall_System_Threading_Interlocked_CompareExchange_T))
...
// aot-compiler.c and aot-runtime.c know about this.
NOHANDLES(ICALL(ILOCK_13, "Exchange(T&,T&,T&)", ves_icall_System_Threading_Interlocked_Exchange_T))
