...
initialize (void)
{
	...
	ERROR_DECL (error);
	if (!mono_thread_create_internal (mono_get_root_domain (), g_cast (selector_thread), NULL, MONO_THREAD_CREATE_FLAGS_THREADPOOL | MONO_THREAD_CREATE_FLAGS_SMALL_STACK, error))
