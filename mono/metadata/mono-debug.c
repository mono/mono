...
void                 mono_add_assembly    (MonoAssemblyLoadContext *alc, MonoAssembly *assembly, gpointer user_data, MonoError *error);
...
mono_debug_init (MonoDebugFormat format)
{
	...
	mono_install_assembly_load_hook_v2 (mono_add_assembly, NULL);
...
void
mono_add_assembly (MonoAssemblyLoadContext *alc, MonoAssembly *assembly, gpointer user_data, MonoError *error)
{
	MonoDebugHandle *handle;
	MonoImage *image;
