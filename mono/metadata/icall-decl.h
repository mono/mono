...
ICALL_EXPORT MonoBoolean ves_icall_System_GCHandle_CheckCurrentDomain (gpointer gchandle);
...
ICALL_EXPORT gpointer ves_icall_System_GCHandle_GetAddrOfPinnedObject (gpointer handle);
...
ICALL_EXPORT void ves_icall_System_GCHandle_FreeHandle (gpointer handle);
