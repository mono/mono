...
mono_openssl_x509_lookup_mono_new (void);

int
mono_openssl_x509_lookup_mono_free (MonoOpenSSLX509LookupMono *mono);

void
mono_openssl_x509_lookup_mono_init (MonoOpenSSLX509LookupMono *mono, const void *instance,
				 MonoOpenSSLX509LookupMono_BySubject by_subject_func);

int
mono_openssl_x509_lookup_add_mono (MonoOpenSSLX509Lookup *lookup, MonoOpenSSLX509LookupMono *mono);

X509_LOOKUP_METHOD *
mono_openssl_x509_lookup_mono_method (void);
