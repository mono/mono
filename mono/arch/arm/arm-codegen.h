...
//
// Solution is to depend on *p being of limited type/size -- not void* and evenly divisible into arminstr_t.
// void* probably does work with gcc/clang but is non-standard and non-msvc.
// Other C++-specific solutions are known, including guaranteed-inline macros w/o address-taken.
//
// We could also make p always the same type. i.e. see mono_arch_build_imt_trampoline.
//
