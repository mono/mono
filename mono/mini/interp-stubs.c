...
mono_interp_stub_init (void)
{
	...
	static const MonoEECallbacks c = {
		NULL, // entry_from_trampoline
		NULL, // to_native_trampoline
		stub_create_method_pointer,
		stub_create_method_pointer_llvmonly,
		stub_runtime_invoke,
		stub_init_delegate,
		stub_delegate_ctor,
		...
		stub_frame_get_this,
		NULL, // frame_arg_to_data
		NULL, // data_to_frame_arg
		NULL, // frame_arg_to_storage
		NULL, // frame_arg_set_storage
	...
	g_assert (
		c.entry_from_trampoline == NULL &&
		c.to_native_trampoline == NULL &&
		c.frame_arg_to_data == NULL &&
		c.frame_arg_set_storage == NULL &&
		c.frame_arg_to_data == NULL &&
		c.frame_arg_set_storage == NULL &&
