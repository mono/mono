...
public:
	...
	void initPassManager () {
		...
		if (opts == NULL) {
			...
			opts = " -simplifycfg -sroa -early-cse -instcombine -correlated-propagation -instcombine -loop-simplify -lcssa -loop-rotate -licm -instcombine -lcssa -indvars -loop-deletion -instcombine";
		}
