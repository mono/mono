...
register_icalls (void)
{
	...
	register_icall_with_wrapper (mono_monitor_enter_internal, mono_icall_sig_int32_obj_obj); // FIXME obj is objref
	register_icall_with_wrapper (mono_monitor_enter_v4_internal, mono_icall_sig_void_obj_ptr_obj); // FIXME obj is objref
	register_icall_no_wrapper (mono_monitor_enter_fast, mono_icall_sig_int_obj); // FIXME obj is objref, there is extra parameter on managed side
	register_icall_no_wrapper (mono_monitor_enter_v4_fast, mono_icall_sig_int_obj_ptr); // FIXME obj is objref, there is extra parameter on managed side
