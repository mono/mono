...
register_icalls (void)
{
	...
	register_opcode_emulation (OP_FCONV_TO_U8, "__emul_fconv_to_u8", mono_icall_sig_ulong_double, mono_fconv_u8, "mono_fconv_u8", FALSE);
	register_opcode_emulation (OP_RCONV_TO_U8, "__emul_rconv_to_u8", mono_icall_sig_ulong_float, mono_rconv_u8, "mono_rconv_u8", FALSE);
	register_opcode_emulation (OP_FCONV_TO_U4, "__emul_fconv_to_u4", mono_icall_sig_uint32_double, mono_fconv_u4, "mono_fconv_u4", FALSE);
	...
	register_icall (mono_class_static_field_address , "mono_class_static_field_address", mono_icall_sig_ptr_ptr_ptr, FALSE);
	register_icall (mono_ldtoken_wrapper, "mono_ldtoken_wrapper", mono_icall_sig_ptr_ptr_ptr_ptr, FALSE);
	register_icall (mono_ldtoken_wrapper_generic_shared, "mono_ldtoken_wrapper_generic_shared", mono_icall_sig_ptr_ptr_ptr_ptr, FALSE);
	...
	register_icall (mono_aot_init_llvm_method, "mono_aot_init_llvm_method", mono_icall_sig_void_ptr_int, TRUE);
	register_icall (mono_aot_init_gshared_method_this, "mono_aot_init_gshared_method_this", mono_icall_sig_void_ptr_int_object, TRUE);
	register_icall (mono_aot_init_gshared_method_mrgctx, "mono_aot_init_gshared_method_mrgctx", mono_icall_sig_void_ptr_int_ptr, TRUE);
	register_icall (mono_aot_init_gshared_method_vtable, "mono_aot_init_gshared_method_vtable", mono_icall_sig_void_ptr_int_ptr, TRUE);

	register_icall_no_wrapper (mono_resolve_iface_call_gsharedvt, "mono_resolve_iface_call_gsharedvt", mono_icall_sig_ptr_object_int_ptr_ptr);
	register_icall_no_wrapper (mono_resolve_vcall_gsharedvt, "mono_resolve_vcall_gsharedvt", mono_icall_sig_ptr_object_int_ptr_ptr);
	register_icall_no_wrapper (mono_resolve_generic_virtual_call, "mono_resolve_generic_virtual_call", mono_icall_sig_ptr_ptr_int_ptr);
	register_icall_no_wrapper (mono_resolve_generic_virtual_iface_call, "mono_resolve_generic_virtual_iface_call", mono_icall_sig_ptr_ptr_int_ptr);
	/* This needs a wrapper so it can have a preserveall cconv */
	register_icall (mono_init_vtable_slot, "mono_init_vtable_slot", mono_icall_sig_ptr_ptr_int, FALSE);
	register_icall (mono_llvmonly_init_delegate, "mono_llvmonly_init_delegate", mono_icall_sig_void_object, TRUE);
	register_icall (mono_llvmonly_init_delegate_virtual, "mono_llvmonly_init_delegate_virtual", mono_icall_sig_void_object_object_ptr, TRUE);
