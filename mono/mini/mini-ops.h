...
MINI_OP(OP_OUTARG_VT,	"outarg_vt", NONE, NONE, NONE)
...
MINI_OP(OP_CHECK_THIS,	"checkthis", NONE, NONE, NONE)
MINI_OP(OP_VOIDCALL,	"voidcall", NONE, NONE, NONE)
MINI_OP(OP_VOIDCALLVIRT,	"voidcallvirt", NONE, NONE, NONE)
MINI_OP(OP_VOIDCALL_REG,	"voidcall_reg", NONE, NONE, NONE)
MINI_OP(OP_VOIDCALL_MEMBASE,	"voidcall_membase", NONE, NONE, NONE)
MINI_OP(OP_FCALL,	"fcall", NONE, NONE, NONE)
MINI_OP(OP_FCALLVIRT,	"fcallvirt", NONE, NONE, NONE)
MINI_OP(OP_FCALL_REG,	"fcall_reg", NONE, NONE, NONE)
MINI_OP(OP_FCALL_MEMBASE,	"fcall_membase", NONE, NONE, NONE)
MINI_OP(OP_LCALL,	"lcall", NONE, NONE, NONE)
MINI_OP(OP_LCALLVIRT,	"lcallvirt", NONE, NONE, NONE)
MINI_OP(OP_LCALL_REG,	"lcall_reg", NONE, NONE, NONE)
MINI_OP(OP_LCALL_MEMBASE,	"lcall_membase", NONE, NONE, NONE)
MINI_OP(OP_VCALL, 	"vcall", NONE, NONE, NONE)
MINI_OP(OP_VCALLVIRT, 	"vcallvirt", NONE, NONE, NONE)
MINI_OP(OP_VCALL_REG,	"vcall_reg", NONE, NONE, NONE)
MINI_OP(OP_VCALL_MEMBASE,	"vcall_membase", NONE, NONE, NONE)
MINI_OP(OP_CALL_REG,	"call_reg", NONE, NONE, NONE)
...
MINI_OP(OP_LOADR4_MEMBASE,"loadr4_membase", IREG, IREG, NONE)
MINI_OP(OP_LOADR8_MEMBASE,"loadr8_membase", IREG, IREG, NONE)
...
MINI_OP(OP_ICONV_TO_R4,"int_conv_to_r4", IREG, IREG, NONE)
MINI_OP(OP_ICONV_TO_R8,"int_conv_to_r8", IREG, IREG, NONE)
MINI_OP(OP_ICONV_TO_U4,"int_conv_to_u4", IREG, IREG, NONE)
MINI_OP(OP_ICONV_TO_U8,"int_conv_to_u8", IREG, IREG, NONE)
...
MINI_OP(OP_X86_COMPARE_MEMBASE_REG,"x86_compare_membase_reg", NONE, NONE, NONE)
MINI_OP(OP_X86_COMPARE_MEMBASE_IMM,"x86_compare_membase_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_COMPARE_MEM_IMM,    "x86_compare_mem_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_COMPARE_MEMBASE8_IMM,"x86_compare_membase8_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_COMPARE_REG_MEMBASE,"x86_compare_reg_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_INC_REG,            "x86_inc_reg", NONE, NONE, NONE)
MINI_OP(OP_X86_INC_MEMBASE,        "x86_inc_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_DEC_REG,            "x86_dec_reg", NONE, NONE, NONE)
MINI_OP(OP_X86_DEC_MEMBASE,        "x86_dec_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_ADD_MEMBASE_IMM,    "x86_add_membase_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_SUB_MEMBASE_IMM,    "x86_sub_membase_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH_MEMBASE,       "x86_push_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH_IMM,           "x86_push_imm", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH,               "x86_push", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH_FP,            "x86_push_fp", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH_OBJ,           "x86_push_obj", NONE, NONE, NONE)
MINI_OP(OP_X86_PUSH_GOT_ENTRY,     "x86_push_got_entry", NONE, NONE, NONE)
MINI_OP(OP_X86_LEA,                "x86_lea", NONE, NONE, NONE)
MINI_OP(OP_X86_LEA_MEMBASE,        "x86_lea_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_XCHG,               "x86_xchg", NONE, NONE, NONE)
MINI_OP(OP_X86_FPOP,               "x86_fpop", NONE, NONE, NONE)
MINI_OP(OP_X86_FP_LOAD_I8,         "x86_fp_load_i8", NONE, NONE, NONE)
MINI_OP(OP_X86_FP_LOAD_I4,         "x86_fp_load_i4", NONE, NONE, NONE)
MINI_OP(OP_X86_SETEQ_MEMBASE,      "x86_seteq_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_SETNE_MEMBASE,      "x86_setne_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_ADD_MEMBASE,        "x86_add_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_SUB_MEMBASE,        "x86_sub_membase", NONE, NONE, NONE)
MINI_OP(OP_X86_MUL_MEMBASE,        "x86_mul_membase", NONE, NONE, NONE)

MINI_OP(OP_AMD64_TEST_NULL,              "amd64_test_null", NONE, NONE, NONE)
MINI_OP(OP_AMD64_SET_XMMREG_R4,          "amd64_set_xmmreg_r4", NONE, NONE, NONE)
MINI_OP(OP_AMD64_SET_XMMREG_R8,          "amd64_set_xmmreg_r8", NONE, NONE, NONE)
...
MINI_OP(OP_AMD64_ICOMPARE_MEMBASE_REG,   "amd64_icompare_membase_reg", NONE, NONE, NONE)
MINI_OP(OP_AMD64_ICOMPARE_MEMBASE_IMM,   "amd64_icompare_membase_imm", NONE, NONE, NONE)
