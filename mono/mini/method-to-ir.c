...
#define IF_P8_MP IF_P8(STACK_MP)
...
bin_num_table [STACK_MAX] [STACK_MAX] = {
	...
	{STACK_INV, IF_P8_I8,  STACK_I8,  IF_P8_PTR, STACK_INV, IF_P8_MP,  STACK_INV, STACK_INV},
	...
	{STACK_INV, STACK_MP,  IF_P8_MP,  STACK_MP,  STACK_INV, STACK_PTR, STACK_INV, STACK_INV},
	{STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV},
	{STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV, STACK_INV},
...
/*	Inv i  L  p  F  &  O  vt r4 */
	{0},
	{0, 1, 0, 1, 0, 1, 0, 0}, /* i, int32 */
	{0, 0, 1,P1, 0,P1, 0, 0}, /* L, int64 */
	{0, 1,P1, 1, 0, 2, 4, 0}, /* p, ptr */
	{0, 0, 0, 0, 1, 0, 0, 0, 1}, /* F, R8 */
	{0, 1,P1, 2, 0, 1, 0, 0}, /* &, managed pointer */
