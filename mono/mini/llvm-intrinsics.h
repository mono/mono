...
INTRINS(SSE_CMPSS, "llvm.x86.sse.cmp.ss")
INTRINS(SSE_CMPSD, "llvm.x86.sse2.cmp.sd")
INTRINS(SSE_COMIEQ_SS, "llvm.x86.sse.comieq.ss")
INTRINS(SSE_COMIGT_SS, "llvm.x86.sse.comigt.ss")
INTRINS(SSE_COMIGE_SS, "llvm.x86.sse.comige.ss")
INTRINS(SSE_COMILT_SS, "llvm.x86.sse.comilt.ss")
INTRINS(SSE_COMILE_SS, "llvm.x86.sse.comile.ss")
INTRINS(SSE_COMINEQ_SS, "llvm.x86.sse.comineq.ss")
INTRINS(SSE_UCOMIEQ_SS, "llvm.x86.sse.ucomieq.ss")
INTRINS(SSE_UCOMIGT_SS, "llvm.x86.sse.ucomigt.ss")
INTRINS(SSE_UCOMIGE_SS, "llvm.x86.sse.ucomige.ss")
INTRINS(SSE_UCOMILT_SS, "llvm.x86.sse.ucomilt.ss")
INTRINS(SSE_UCOMILE_SS, "llvm.x86.sse.ucomile.ss")
INTRINS(SSE_UCOMINEQ_SS, "llvm.x86.sse.ucomineq.ss")
...
INTRINS(SSE_MINSS, "llvm.x86.sse.min.ss")
INTRINS(SSE_MAXSS, "llvm.x86.sse.max.ss")
